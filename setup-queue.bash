...
aws --endpoint-url=http://localhost:4576 sqs set-queue-attributes \
    --queue-url http://localhost:4576/queue/outbound_referral_queue --attributes file://outbound-referral-queue-attributes.json
...
aws --endpoint-url=http://localhost:4576 sqs set-queue-attributes \
    --queue-url http://localhost:4576/queue/inbound_deletion_queue --attributes file://inbound-deletion-queue-attributes.json
...
aws --endpoint-url=http://localhost:4576 sqs set-queue-attributes \
    --queue-url http://localhost:4576/queue/outbound_deletion_queue --attributes file://outbound-deletion-queue-attributes.json
