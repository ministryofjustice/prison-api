...
export class InMemoryDBMockData implements InMemoryDbService {
  createDb() {
    ...
    let locations = [
      ...
      { id: 8724, agencyId: 'SDP', locationType: 'TIER', description: 'SDP-PEN-DEATH ROW', parentLocationId: 8723, operationalCapacity: 1, currentOccupancy: 1, livingUnit: true, housingUnitType: 'DR',  },
