...
@Component({
  ...
  <div *ngIf="inmate">
    ...
    <div *ngIf="inmate.facialImageId"><img src="{{apiUrl}}api/images/{{inmate.facialImageId}}/data" alt="Inmate front facial image."/></div>
    <table>
    ...
    <div *ngIf="inmate.physicalCharacteristics">
      ...
      <table>
        <tr *ngFor="let pc of inmate.physicalCharacteristics">
          ...
          <td>{{pc.detail}}</td>
          <td><img *ngIf="pc.imageId" src="{{apiUrl}}api/images/{{pc.imageId}}/data"/></td>
        </tr>
      </table>
      <div *ngIf="inmate.physicalCharacteristics.length == 0">none</div>
    </div>
    <div *ngIf="inmate.physicalMarks">
      ...
      <table>
        <tr *ngFor="let pm of inmate.physicalMarks">
          ...
          <td>{{pm.comment}}</td>
          <td><img *ngIf="pm.imageId" src="{{apiUrl}}api/images/{{pm.imageId}}/data"/></td>
        </tr>
      </table>
      <div *ngIf="inmate.physicalMarks.length == 0"><i>none</i></div>
    </div>
  <div>
