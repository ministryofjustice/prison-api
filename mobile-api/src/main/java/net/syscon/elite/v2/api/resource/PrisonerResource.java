...
public interface PrisonerResource {
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Prisoners successfully retrieved.", response = PrisonerDetail.class, responseContainer = "List",
                    responseHeaders = {
                            ...
                            @ResponseHeader(name = "Record-Limit", description = "Limit for number of records returned", response = Long.class)
    ...
    GetPrisonersResponse getPrisoners(@ApiParam(value = "Search by first name (wildcard)") @QueryParam("firstName") String firstName,
                                      ...
                                      @ApiParam(value = "Limit for number of records returned") @HeaderParam("Record-Limit") Long limit);
    ...
    class GetPrisonersResponse extends ResponseDelegate {
        ...
        public static GetPrisonersResponse respond200WithApplicationJson(List<PrisonerDetail> entity, Long limit, Long totalRecords) {
            Response.ResponseBuilder responseBuilder = Response.status(200)
                    .header("Content-Type", "application/json")
                    .header("Total-Records", totalRecords)
                    .header("Record-Limit", limit);
