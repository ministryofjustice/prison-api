...
public class ReferenceCodeRepositoryTest {
    ...
    public void testGetReferenceCodesByDomainWithoutSubCodes1() {
        ...
        assertThat(refCodes.getTotalRecords()).isEqualTo(57);
    ...
    public void testGetReferenceCodesByDomainWithSubCodes1() {
        ...
        assertThat(refCodes.getItems()).isNotEmpty();
        assertThat(refCodes.getItems().size()).isEqualTo(10);
        assertThat(refCodes.getTotalRecords()).isEqualTo(46);
        assertThat(refCodes.getPageOffset()).isEqualTo(0);
        assertThat(refCodes.getPageLimit()).isEqualTo(10);
    ...
    public void testGetReferenceCodesByDomainWithSubCodes2() {
        Page<ReferenceCode> refCodes =
                repository.getReferenceCodesByDomain("TASK_TYPE", true,"code", Order.DESC, 15, 15);
        ...
        assertThat(refCodes.getItems().get(14).getCode()).isEqualTo("FILEINSP");
        ...
        assertThat(refCodes.getItems().get(14).getSubCodes().size()).isEqualTo(3);
        ...
        assertThat(refCodes.getItems().get(14).getSubCodes().get(0).getCode()).isEqualTo("BYSPO");
        assertThat(refCodes.getItems().get(14).getSubCodes().get(2).getCode()).isEqualTo("BYACO");
    ...
    public void testGetReferenceCodesByDomainWithoutSubCodes3() {
        ...
        assertThat(refCodes.getItems()).isNotNull();
        assertThat(refCodes.getItems()).isNotEmpty();
        assertThat(refCodes.getItems().size()).isEqualTo(57);
        assertThat(refCodes.getTotalRecords()).isEqualTo(57);
        assertThat(refCodes.getPageOffset()).isEqualTo(0);
        ...
        assertThat(refCodes.getItems().get(0).getCode()).isEqualTo("ACP");
        assertThat(refCodes.getItems().get(9).getCode()).isEqualTo("COMMS");
        assertThat(refCodes.getItems().get(56).getCode()).isEqualTo("VLU");
    ...
    public void testGetReferenceCodesByDomainWithSubCodes3() {
        ...
        assertThat(refCodes.getItems()).isNotNull();
        assertThat(refCodes.getItems()).isNotEmpty();
        assertThat(refCodes.getItems().size()).isEqualTo(46);
        assertThat(refCodes.getTotalRecords()).isEqualTo(46);
        assertThat(refCodes.getPageOffset()).isEqualTo(0);
        assertThat(refCodes.getPageLimit()).isEqualTo(1000);
        ...
        assertThat(refCodes.getItems().get(0).getCode()).isEqualTo("ACP");
        assertThat(refCodes.getItems().get(9).getCode()).isEqualTo("CRT");
        assertThat(refCodes.getItems().get(45).getCode()).isEqualTo("VICTIM");
        ...
        assertThat(refCodes.getItems().get(9).getSubCodes().get(0).getCode()).isEqualTo("APP");
        assertThat(refCodes.getItems().get(9).getSubCodes().get(14).getCode()).isEqualTo("TRA");
        assertThat(refCodes.getItems().get(45).getSubCodes().get(0).getCode()).isEqualTo("INFO_COMPLET");
        assertThat(refCodes.getItems().get(45).getSubCodes().get(1).getCode()).isEqualTo("INFO_UPDATE");
    ...
    public void testGetReferenceCodesByDomainWithSubCodes6() {
        Page<ReferenceCode> refCodes =
                repository.getReferenceCodesByDomain("TASK_TYPE", true,"description", Order.DESC, 15, 15);
        ...
        assertThat(refCodes.getItems().get(14).getCode()).isEqualTo("FARES");
        assertThat(refCodes.getItems().get(14).getDescription()).isEqualTo("Fares");
        ...
        assertThat(refCodes.getItems().get(14).getSubCodes().size()).isEqualTo(2);
        ...
        assertThat(refCodes.getItems().get(14).getSubCodes().get(0).getCode()).isEqualTo("TOBEPAID");
        assertThat(refCodes.getItems().get(14).getSubCodes().get(0).getDescription()).isEqualTo("To Be Paid");
        assertThat(refCodes.getItems().get(14).getSubCodes().get(1).getCode()).isEqualTo("NOTPAID");
        assertThat(refCodes.getItems().get(14).getSubCodes().get(1).getDescription()).isEqualTo("Not To Be Paid");
