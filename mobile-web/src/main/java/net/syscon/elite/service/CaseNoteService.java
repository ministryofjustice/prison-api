...
public interface CaseNoteService {
    ...
    List<CaseNoteUsage> getCaseNoteUsage(String type, String subType, @NotEmpty List<String> offenderNo, Integer staffId, LocalDate fromDate, LocalDate toDate, int numMonths);
