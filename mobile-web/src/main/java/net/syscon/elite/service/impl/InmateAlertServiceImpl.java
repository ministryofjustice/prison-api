...
public class InmateAlertServiceImpl implements InmatesAlertService {
    ...
    @Override
    public List<Alert> getInmateAlerts(long bookingId, final String query, final String orderByField, Order order,
        ...
        final List<Alert> alerts = inmateAlertRepository.getInmateAlert(bookingId, query, colSort, order, offset,
                limit);
