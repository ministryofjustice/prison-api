...
public interface InmateRepository {
	...
	List<OffenderBookingImpl> searchForOffenderBookings(String keywords, String locationId, int offset, int limit, String orderBy, boolean isAscendingOrder);
	...
	List<PrisonerDetailImpl> searchForOffenders(String query, Date fromDobDate, Date toDobDate, String sortFields, boolean ascendingOrder);
}
