...
(	REC_ACCOUNT_CODE DECIMAL(6,0), 
	ACCOUNT_CODE DECIMAL(6,0) PRIMARY KEY NOT NULL,      -- 'General ledger account code.';
	...
	LIST_SEQ DECIMAL(6,0) DEFAULT 99,                    -- 'The sequence in which the data should be shown';
	CASELOAD_TYPE VARCHAR(12),                           -- 'The Case Load Type';
	PARENT_ACCOUNT_CODE DECIMAL(6,0),                    -- 'Parent_code to Account_code';
	CREATE_DATETIME TIMESTAMP (9) DEFAULT now() NOT NULL,-- 'The timestamp when the record is created';
