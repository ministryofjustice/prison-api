...
ALTER TABLE OFFENDER_OIC_SANCTIONS ADD FOREIGN KEY (OFFENDER_BOOK_ID) REFERENCES OFFENDER_BOOKINGS;
--ALTER TABLE OFFENDER_OIC_SANCTIONS ADD FOREIGN KEY (CONSECUTIVE_OFFENDER_BOOK_ID) REFERENCES OFFENDER_BOOKINGS;
...
ALTER TABLE OFFENDER_OIC_SANCTIONS ADD FOREIGN KEY (OIC_HEARING_ID, RESULT_SEQ) REFERENCES OIC_HEARING_RESULTS;
