...
GRANT SELECT, INSERT, UPDATE ON OFFENDER_IND_SCHEDULES TO TAG_USER;
GRANT SELECT ON OFFENDER_KEY_DATE_ADJUSTS TO TAG_USER;
GRANT SELECT, INSERT, UPDATE ON OFFENDER_KEY_WORKERS TO TAG_USER;
...
GRANT SELECT, UPDATE, INSERT ON PERSON_IDENTIFIERS TO TAG_USER;
...
GRANT SELECT ON STAFF_LOCATION_ROLES TO TAG_USER;
...
GRANT SELECT ON EVENT_ID TO TAG_USER;
...
-- Currently needed for BDD test cleanup
GRANT DELETE ON OFFENDER_KEY_WORKERS TO API_PROXY_USER;
