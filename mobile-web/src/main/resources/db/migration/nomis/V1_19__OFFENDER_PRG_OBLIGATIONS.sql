...
(
  ...
  "STATUS"                        VARCHAR2(12 CHAR) DEFAULT 'REF'     NOT NULL ,
  "START_DATE"                    DATE,
  "END_DATE"                      DATE,
  ...
  "OBLIGATION_SOURCE"             VARCHAR2(12 CHAR) DEFAULT 'ORDERED' NOT NULL ,
  ...
  CONSTRAINT "OFFENDER_PRG_OBLIGATIONS_PK" PRIMARY KEY ("OFFENDER_PRG_OBLIGATION_ID") ,
