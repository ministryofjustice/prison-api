...
(
  ...
  CONSTRAINT "STAFF_STAFF_F1" FOREIGN KEY ("SUPERVISOR_STAFF_ID")
  REFERENCES "STAFF_MEMBERS" ("STAFF_ID") ,
  CONSTRAINT "STAFF_CSLD_F2" FOREIGN KEY ("WORKING_CASELOAD_ID")
  REFERENCES "CASELOADS" ("CASELOAD_ID") ,
  CONSTRAINT "STAFF_CSLD_F1" FOREIGN KEY ("ASSIGNED_CASELOAD_ID")
  REFERENCES "CASELOADS" ("CASELOAD_ID")
);
