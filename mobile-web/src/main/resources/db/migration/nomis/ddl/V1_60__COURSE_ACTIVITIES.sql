...
(
  ...
  CONSTRAINT "CSR_ACTY_PRG_SERV_FK" FOREIGN KEY ("PROGRAM_ID")             REFERENCES "PROGRAM_SERVICES" ("PROGRAM_ID")   ,
  CONSTRAINT "CRS_ACT_CRS_ACT_FK"   FOREIGN KEY ("PARENT_CRS_ACTY_ID")     REFERENCES "COURSE_ACTIVITIES" ("CRS_ACTY_ID") ,
  CONSTRAINT "CRS_ACTY_AGY_LOC_FK"  FOREIGN KEY ("AGY_LOC_ID")             REFERENCES "AGENCY_LOCATIONS" ("AGY_LOC_ID") ,
  CONSTRAINT "CRS_ACTY_ADDR_FK"     FOREIGN KEY ("SERVICES_ADDRESS_ID")    REFERENCES "ADDRESSES" ("ADDRESS_ID") ,
  CONSTRAINT "CRS_ACTY_CORP_FK"     FOREIGN KEY ("PLACEMENT_CORPORATE_ID") REFERENCES "CORPORATES" ("CORPORATE_ID")
);
