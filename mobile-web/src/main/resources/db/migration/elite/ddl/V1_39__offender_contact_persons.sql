...
(
  ...
  APPROVED_VISITOR_FLAG      VARCHAR2(1)     DEFAULT 'N',
  CASELOAD_TYPE              VARCHAR2(12),
  MODIFY_DATETIME            TIMESTAMP       DEFAULT SYSTIMESTAMP,
  MODIFY_USER_ID             VARCHAR2(32),
  COMMENT_TEXT               VARCHAR2(240),
  CASE_INFO_NUMBER           VARCHAR2(60),
  AWARE_OF_CHARGES_FLAG      VARCHAR2(1),
  CAN_BE_CONTACTED_FLAG      VARCHAR2(1),
  CREATE_DATETIME            TIMESTAMP       DEFAULT SYSTIMESTAMP NOT NULL,
  CREATE_USER_ID             VARCHAR2(32)    DEFAULT user         NOT NULL,
  EMERGENCY_CONTACT_FLAG     VARCHAR2(1)     DEFAULT 'N'          NOT NULL,
  NEXT_OF_KIN_FLAG           VARCHAR2(1)     DEFAULT 'N'          NOT NULL,
  ACTIVE_FLAG                VARCHAR2(1)     DEFAULT 'N'          NOT NULL,
  EXPIRY_DATE                DATE,
  OFFENDER_CONTACT_PERSON_ID NUMBER(10),
