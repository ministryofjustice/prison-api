...
/*
CREATE UNIQUE INDEX OFFENDER_EXTERNAL_MOVEMENTS
  ON OFFENDER_EXTERNAL_MOVEMENTS (OFFENDER_BOOK_ID, MOVEMENT_SEQ);

ALTER TABLE OFFENDER_EXTERNAL_MOVEMENTS
  ADD CONSTRAINT OFFENDER_EXTERNAL_MOVEMENTS_PK
PRIMARY KEY (OFFENDER_BOOK_ID, MOVEMENT_SEQ);
