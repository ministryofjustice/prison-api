...
INSERT INTO STAFF_LOCATION_ROLES (CAL_AGY_LOC_ID, SAC_STAFF_ID, FROM_DATE, TO_DATE, POSITION, ROLE, SCHEDULE_TYPE, HOURS_PER_WEEK) VALUES ('LEI-X', -2, TO_DATE('2016-08-08','YYYY-MM-DD'), NULL,                               'PRO', 'KW', 'FT', 7);
INSERT INTO STAFF_LOCATION_ROLES (CAL_AGY_LOC_ID, SAC_STAFF_ID, FROM_DATE, TO_DATE, POSITION, ROLE, SCHEDULE_TYPE, HOURS_PER_WEEK) VALUES ('LEI-X', -2, TO_DATE('2016-08-08','YYYY-MM-DD'), NULL,                               'AO', 'KW', 'FT', 2);

INSERT INTO STAFF_LOCATION_ROLES (CAL_AGY_LOC_ID, SAC_STAFF_ID, FROM_DATE, TO_DATE, POSITION, ROLE, SCHEDULE_TYPE, HOURS_PER_WEEK) VALUES ('LEI', -2, TO_DATE('2016-08-08','YYYY-MM-DD'), NULL,                               'PRO', 'KW', 'FT', 7);
