...
FIND_INMATE_ALIASES {
    SELECT OFFENDERS.LAST_NAME,
     ...
     WHERE OFFENDERS.ROOT_OFFENDER_ID = OFFENDER_BOOKINGS.ROOT_OFFENDER_ID
           ...
           AND OFFENDERS.SEX_CODE = REF_CD_SEX.CODE
           AND REF_CD_SEX.DOMAIN = 'SEX'
}
...
FIND_MY_ASSIGNMENTS {
  ...
  FROM OFFENDER_BOOKINGS B
    ...
    JOIN STAFF_MEMBERS S ON B.ASSIGNED_STAFF_ID = S.STAFF_ID
  WHERE B.ACTIVE_FLAG = 'Y'
