...
FIND_ACTIVE_APPROVED_ASSESSMENT {
  ...
  FROM OFFENDER_ASSESSMENTS off_ass JOIN ASSESSMENTS ass ON off_ass.ASSESSMENT_TYPE_ID = ass.ASSESSMENT_ID
    LEFT JOIN REFERENCE_CODES ref_review ON off_ass.review_sup_level_type = ref_review.CODE AND ref_review.DOMAIN = 'SUP_LVL_TYPE'
    LEFT JOIN REFERENCE_CODES ref_override ON off_ass.overrided_sup_level_type = ref_override.CODE AND ref_override.DOMAIN = 'SUP_LVL_TYPE'
    LEFT JOIN REFERENCE_CODES ref_cal_sup ON off_ass.calc_sup_level_type = ref_cal_sup.CODE AND ref_cal_sup.DOMAIN = 'SUP_LVL_TYPE'
