...
SELECT B.AGY_LOC_ID,
  ...
  NVL((SELECT initcap(substr(SYS_CONNECT_BY_PATH(A.INTERNAL_LOCATION_TYPE || ' ' || A.INTERNAL_LOCATION_CODE, '|'),2))
       ...
       START WITH A.agy_loc_id = I.agy_loc_id and A.INTERNAL_LOCATION_TYPE = :locationTypeRoot
...
FIND_ALL_INMATES {
      SELECT
        ...
        NVL((SELECT initcap(substr(SYS_CONNECT_BY_PATH(A.INTERNAL_LOCATION_TYPE || ' ' || A.INTERNAL_LOCATION_CODE, '|'),2))
             ...
             START WITH A.agy_loc_id = AIL.agy_loc_id and A.INTERNAL_LOCATION_TYPE = :locationTypeRoot
