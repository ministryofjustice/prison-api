...
SELECT B.AGY_LOC_ID,
  ...
  NVL((SELECT initcap(substr(SYS_CONNECT_BY_PATH(A.INTERNAL_LOCATION_TYPE || ' ' || A.INTERNAL_LOCATION_CODE, '/'),2))
       ...
       WHERE A.INTERNAL_LOCATION_ID = I.INTERNAL_LOCATION_ID
       START WITH A.INTERNAL_LOCATION_TYPE = :locationTypeRoot
       CONNECT BY PRIOR A.INTERNAL_LOCATION_ID = A.PARENT_INTERNAL_LOCATION_ID), I.DESCRIPTION) as LIVING_UNIT_DESCRIPTION,
