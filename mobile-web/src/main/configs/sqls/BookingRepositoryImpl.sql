...
GET_BOOKING_APPOINTMENTS {
  SELECT OFFENDER_BOOK_ID AS BOOKING_ID,
         ...
         COALESCE(AIL.USER_DESC, AIL.DESCRIPTION, AGY.DESCRIPTION) AS EVENT_LOCATION,
         'XXX' AS EVENT_SOURCE,
         NULL AS EVENT_SOURCE_CODE,
         NULL AS EVENT_SOURCE_DESC
  FROM OFFENDER_BOOKINGS OB
    LEFT JOIN REFERENCE_CODES RC1 ON RC1.CODE = 'XXX' AND RC1.DOMAIN = 'INT_SCH_TYPE'
    LEFT JOIN REFERENCE_CODES RC2 ON RC2.CODE = 'XXX' AND RC2.DOMAIN = 'INT_SCH_RSN'
    LEFT JOIN AGENCY_INTERNAL_LOCATIONS AIL ON 0 = AIL.INTERNAL_LOCATION_ID
    LEFT JOIN AGENCY_LOCATIONS AGY ON OB.AGY_LOC_ID = AGY.AGY_LOC_ID
