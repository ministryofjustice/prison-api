...
public class CourtEvent {
    ...
    @Schema(requiredMode = REQUIRED, description = "The internal event ID", example = "12343434")
    private Long eventId;

    @Schema(requiredMode = REQUIRED, description = "The agency code ", example = "LEI")
    ...
    @Schema(requiredMode = REQUIRED, description = "The agency code to which the transfer will be made (if an agency)", example = "LEEDCC")
    private String toAgency;

    @Schema(requiredMode = REQUIRED, description = "The to agency description", example = "Leeds Crown Court")
    private String toAgencyDescription;

    @Schema(requiredMode = REQUIRED, description = "The date on which the event is scheduled to occur", example = "2019-12-01")
    private LocalDate eventDate;

    @Schema(requiredMode = REQUIRED, description = "The planned date and time of the start of the event in Europe/London (ISO 8601) format without timezone offset e.g. YYYY-MM-DDTHH:MM:SS.", example = "2019-12-01T14:00:00")
    private LocalDateTime startTime;

    @Schema(requiredMode = REQUIRED, description = "The planned date and time of the end of the event in Europe/London (ISO 8601) format without timezone offset e.g. YYYY-MM-DDTHH:MM:SS.", example = "2019-12-01T14:40:00")
    private LocalDateTime endTime;

    @Schema(requiredMode = REQUIRED, description = "The event class (from COURT_EVENTS)", example = "EXT_MOV")
    private String eventClass;

    @Schema(requiredMode = REQUIRED, description = "The event type", example = "CRT")
    private String eventType;

    @Schema(requiredMode = REQUIRED, description = "The event sub-type", example = "DP")
    private String eventSubType;

    @Schema(requiredMode = REQUIRED, description = "The event status - either SCH (scheduled) or COMP (completed)", example = "SCH")
    private String eventStatus;

    @Schema(requiredMode = REQUIRED, description = "Judge name, where available", example = "Harris")
    private String judgeName;

    @Schema(requiredMode = REQUIRED, description = "The direction code (IN or OUT)", example = "IN")
    private String directionCode;

    @Schema(requiredMode = REQUIRED, description = "The comment text stored against this event", example = "Restricted access to parking level")
