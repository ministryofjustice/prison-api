...
public class CaseNoteResource {
    ...
    @PostMapping("/staff-usage") // YES, called
    @SlowReportQuery
    // ??? @VerifyOffenderAccess(overrideRoles = {"VIEW_CASE_NOTES"})
    ...
    @PostMapping("/usage-by-types") // YES, called
    @SlowReportQuery
    @VerifyOffenderAccess(overrideRoles = {"VIEW_CASE_NOTES"})
