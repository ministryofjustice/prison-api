...
public class PrisonerResource {
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "OK", content = {@Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = PrisonerDetail.class)))}),
