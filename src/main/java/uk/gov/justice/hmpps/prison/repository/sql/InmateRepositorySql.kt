    ...
    """
        ...
        AND B.LIVING_UNIT_ID IN (
            WITH LOCATION_SUBQUERY (INTERNAL_LOCATION_ID, PARENT_INTERNAL_LOCATION_ID) AS (
                SELECT INTERNAL_LOCATION_ID, PARENT_INTERNAL_LOCATION_ID FROM AGENCY_INTERNAL_LOCATIONS WHERE INTERNAL_LOCATION_ID = :locationId AND PARENT_INTERNAL_LOCATION_ID IS NULL
                UNION ALL
