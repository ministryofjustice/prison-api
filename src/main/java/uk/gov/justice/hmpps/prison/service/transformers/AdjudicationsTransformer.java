...
public class AdjudicationsTransformer {
    ...
    public static AdjudicationDetail transformToDto(final Adjudication adjudication) {
        ...
        return AdjudicationDetail.builder()
            ...
            .reporterStaffId(adjudication.getStaffReporter() != null ? adjudication.getStaffReporter().getStaffId() : null)
            .bookingId(bookingId)
            .offenderNo(offenderNo)
            .agencyId(adjudication.getAgencyLocation() != null ? adjudication.getAgencyLocation().getId() : null)
            .incidentTime(adjudication.getIncidentTime())
            .incidentLocationId(adjudication.getInternalLocation() != null ? adjudication.getInternalLocation().getLocationId() : null)
