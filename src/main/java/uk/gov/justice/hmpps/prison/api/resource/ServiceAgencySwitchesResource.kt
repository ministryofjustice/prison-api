...
class ServiceAgencySwitchesResource(private val service: ServiceAgencySwitchesService) {
  ...
  @Operation(
    ...
    description = """Returns a list of agencies switched on for the service code.
      ...
      Requires ROLE_PRISON_API__SERVICE_AGENCY_SWITCHES__RO, PRISON_API__SERVICE_AGENCY_SWITCHES__RW.
    """,
  )
  ...
  @Operation(summary = "Activates an agency for the given service", description = "Requires ROLE_PRISON_API__SERVICE_AGENCY_SWITCHES__RW")
  @PreAuthorize("hasAnyRole('PRISON_API__SERVICE_AGENCY_SWITCHES__RW')")
  ...
  @Operation(summary = "Deactivates an agency for the given service", description = "Requires ROLE_PRISON_API__SERVICE_AGENCY_SWITCHES__RW")
  @PreAuthorize("hasAnyRole('PRISON_API__SERVICE_AGENCY_SWITCHES__RW')")
