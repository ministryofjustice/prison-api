...
public class MovementResource {
    ...
    public ResponseEntity<List<OffenderIn>> getMovementsIn(@PathVariable("agencyId") @ApiParam(value = "The prison id", required = true) final String agencyId, @RequestParam("fromDateTime") @org.springframework.format.annotation.DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) @ApiParam(value = "fromDateTime", required = true) final LocalDateTime fromDate, @RequestParam(value = "toDateTime", required = false) @org.springframework.format.annotation.DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) @ApiParam(value = "toDateTime") final LocalDateTime toDate, @RequestHeader(value = "Page-Offset", defaultValue = "0", required = false) @ApiParam(value = "Requested offset of first record in returned collection of prisoner records.", defaultValue = "0") final Long pageOffset, @RequestHeader(value = "Page-Limit", defaultValue = "10", required = false) @ApiParam(value = "Requested limit to number of records returned.", defaultValue = "10") final Long pageLimit) {
