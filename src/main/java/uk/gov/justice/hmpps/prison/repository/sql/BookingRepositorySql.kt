...
enum class BookingRepositorySql(val sql: String) {
  ...
  GET_OFFENDER_SENT_CALCULATIONS_FOR_PRISONER(
    """
        ...
        OSC.RECORD_USER_ID                  CALCULATED_BY_USER_ID,
        SM.FIRST_NAME                       CALCULATED_BY_FIRST_NAME,
        SM.LAST_NAME                       CALCULATED_BY_LAST_NAME
        ...
        INNER JOIN STAFF_USER_ACCOUNTS SUA ON SUA.USERNAME = OSC.RECORD_USER_ID
