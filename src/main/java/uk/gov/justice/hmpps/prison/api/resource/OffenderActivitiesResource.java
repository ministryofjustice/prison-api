...
public class OffenderActivitiesResource {
    ...
    @SlowReportQuery
    public Page<OffenderActivitySummary> getRecentStartedActivities(@PathVariable @Parameter(description = "The offenderNo of the prisoner", required = true) final String offenderNo,
    ...
    @SlowReportQuery
    public Page<OffenderAttendance> getHistoricalAttendances(@PathVariable @Parameter(description = "The offenderNo of the prisoner", required = true) final String offenderNo,
