...
public class OffenderDatesService {
    ...
    private OffenderCalculatedKeyDates getOffenderCalculatedKeyDates(SentenceCalculation sentenceCalculation) {
        return OffenderCalculatedKeyDates.offenderCalculatedKeyDates()
            ...
            .homeDetentionCurfewEligibilityDateOverridden(sentenceCalculation.isHomeDetentionCurfewEligibilityDateOverridden())
            ...
            .automaticReleaseDateOverridden(sentenceCalculation.isAutomaticReleaseDateOverridden())
            .conditionalReleaseDate(sentenceCalculation.getConditionalReleaseDate())
            .conditionalReleaseDateOverridden(sentenceCalculation.isConditionalReleaseDateOverridden())
            .paroleEligibilityDate(sentenceCalculation.getParoleEligibilityDate())
            .paroleEligibilityDateOverridden(sentenceCalculation.isParoleEligibilityDateOverridden())
            .nonParoleDate(sentenceCalculation.getNonParoleDate())
            .nonParoleDateOverridden(sentenceCalculation.isNonParoleDateOverridden())
            .licenceExpiryDate(sentenceCalculation.getLicenceExpiryDate())
            .licenceExpiryDateOverridden(sentenceCalculation.isLicenceExpiryDateOverridden())
            ...
            .sentenceExpiryDateOverridden(sentenceCalculation.isSentenceExpiryDateOverridden())
            .topupSupervisionExpiryDate(sentenceCalculation.getTopupSupervisionExpiryDate())
            .topupSupervisionExpiryDateOverridden(sentenceCalculation.isTopupSupervisionExpiryDateOverridden())
