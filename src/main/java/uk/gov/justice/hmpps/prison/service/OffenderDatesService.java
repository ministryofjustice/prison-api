...
public class OffenderDatesService {
    ...
    private OffenderCalculatedKeyDates getOffenderCalculatedKeyDates(SentenceCalculation sentenceCalculation) {
        return OffenderCalculatedKeyDates.offenderCalculatedKeyDates()
            ...
            .isHomeDetentionCurfewEligibilityDateOverridden(sentenceCalculation.isHomeDetentionCurfewEligibilityDateOverridden())
            ...
            .isAutomaticReleaseDateOverridden(sentenceCalculation.isAutomaticReleaseDateOverridden())
            .conditionalReleaseDate(sentenceCalculation.getConditionalReleaseDate())
            .isConditionalReleaseDateOverridden(sentenceCalculation.isConditionalReleaseDateOverridden())
            .paroleEligibilityDate(sentenceCalculation.getParoleEligibilityDate())
            .isParoleEligibilityDateOverridden(sentenceCalculation.isParoleEligibilityDateOverridden())
            .nonParoleDate(sentenceCalculation.getNonParoleDate())
            .isNonParoleDateOverridden(sentenceCalculation.isNonParoleDateOverridden())
            .licenceExpiryDate(sentenceCalculation.getLicenceExpiryDate())
            .isLicenceExpiryDateOverridden(sentenceCalculation.isLicenceExpiryDateOverridden())
            ...
            .isSentenceExpiryDateOverridden(sentenceCalculation.isSentenceExpiryDateOverridden())
            .topupSupervisionExpiryDate(sentenceCalculation.getTopupSupervisionExpiryDate())
            .isTopupSupervisionExpiryDateOverridden(sentenceCalculation.isTopupSupervisionExpiryDateOverridden())
