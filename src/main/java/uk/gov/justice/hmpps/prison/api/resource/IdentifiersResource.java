...
public class IdentifiersResource {
    ...
    public List<OffenderIdentifier> getOffenderIdentifiersByTypeAndValue(@javax.validation.constraints.NotNull @PathVariable("type") @ApiParam(value = "Identifier Type", example = "PNC", required = true) final String identifierType, @javax.validation.constraints.NotNull @PathVariable("value") @ApiParam(value = "Identifier Value", example = "1234/XX", required = true) final String identifierValue) {
