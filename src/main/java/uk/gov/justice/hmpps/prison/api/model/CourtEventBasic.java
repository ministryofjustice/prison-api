...
public class CourtEventBasic {
    ...
    @Schema(requiredMode = REQUIRED, description = "The agency code of the court", example = "LEEDCC")
    private String court;

    @Schema(description = "The court description", example = "Leeds Crown Court")
    private String courtDescription;

    @Schema(requiredMode = REQUIRED, description = "The planned date and time of the start of the event in Europe/London (ISO 8601) format without timezone offset e.g. YYYY-MM-DDTHH:MM:SS.", example = "2020-12-01T14:00:00")
    private LocalDateTime startTime;

    @Schema(requiredMode = REQUIRED, description = "The court event subtype (from MOVE_RSN reference data)", example = "CRT")
