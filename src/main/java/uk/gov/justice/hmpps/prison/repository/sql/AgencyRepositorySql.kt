    ...
    """
      ...
      WHERE A.ACTIVE_FLAG = COALESCE(:activeFlag, A.ACTIVE_FLAG)
        ...
        AND C.CASELOAD_ID IN (
          SELECT UCR.CASELOAD_ID FROM USER_ACCESSIBLE_CASELOADS UCR
            JOIN CASELOADS CL ON CL.CASELOAD_ID = UCR.CASELOAD_ID AND CL.CASELOAD_TYPE = :caseloadType AND CL.CASELOAD_FUNCTION = :caseloadFunction
