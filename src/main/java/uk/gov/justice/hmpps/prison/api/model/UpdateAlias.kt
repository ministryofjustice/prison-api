...
@Schema(description = "Update prisoner's alias")
data class UpdateAlias(
  ...
  @Schema(description = "Prisoner's first middle name.", example = "Middleone")
  @field:Size(max = 35)
  @field:Pattern(regexp = "^[A-Z|a-z ,.'-]+$", message = "Middle name 1 is not valid")
  val middleName1: String? = null,

  @Schema(description = "Prisoner's second middle name.", example = "Middleone")
  @field:Size(max = 35)
