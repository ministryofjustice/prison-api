...
public class EmploymentResource {
    ...
    @ApiOperation(value = "A list of offender employments.", notes = "A list of offender employments.  Requires VIEW_PRISONER_DATA or SYSTEM_USER role", nickname = "getPrisonerEmployments")
