...
public class SchedulePrisonToPrisonMove {
    ...
    @Schema(requiredMode = REQUIRED, description = "The prison (agency code) to be moved from.", example = "LEI")
    ...
    @Schema(requiredMode = REQUIRED, description = "The prison (agency code) to be moved to.", example = "PVI")
    ...
    @Schema(requiredMode = REQUIRED, description = "The date and time of the move in Europe/London (ISO 8601) format without timezone offset e.g. YYYY-MM-DDTHH:MM:SS.", example = "2020-02-28T14:40:00")
