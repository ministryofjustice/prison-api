...
public class InmateDetail {
    ...
    @Schema(description = "Last Movement Type Code of prisoner", example = "TAP", allowableValues = "TAP,CRT,TRN,ADM,REL. Note: Reference Data from MOVE_TYPE Domain")
    private String lastMovementTypeCode;

    @Schema(description = "Last Movement Reason of prisoner", example = "CA. Note: Reference Data from MOVE_RSN Domain")
    private String lastMovementReasonCode;

    @Schema(description = "Legal Status", example = "REMAND. Note: Only returned when requesting extra details")
    private LegalStatus legalStatus;

    @Schema(description = "Recall", example = "true. Note: Only returned when requesting extra details")
    private Boolean recall;

    @Schema(description = "The prisoner's imprisonment status.", example="LIFE. Note: Only returned when requesting extra details")
    private String imprisonmentStatus;

    @Schema(description = "The prisoner's imprisonment status description.", example="Serving Life Imprisonment. Note: Only returned when requesting extra details")
