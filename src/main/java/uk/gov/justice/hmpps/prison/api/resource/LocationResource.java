...
public class LocationResource {
    ...
    public ResponseEntity<List<OffenderBooking>> getOffendersAtLocationDescription(
            @PathVariable("locationPrefix") @ApiParam(value = "", required = true) final String locationPrefix, @RequestParam(value = "keywords", required = false) @ApiParam("offender name or id to match") final String keywords, @RequestParam(value = "fromDob", required = false) @org.springframework.format.annotation.DateTimeFormat(iso = DateTimeFormat.ISO.DATE) @ApiParam(value = "Offenders with a DOB >= this date", example = "1970-01-02") final LocalDate fromDob, @RequestParam(value = "toDob", required = false) @org.springframework.format.annotation.DateTimeFormat(iso = DateTimeFormat.ISO.DATE) @ApiParam(value = "Offenders with a DOB <= this date", example = "1975-01-02") final LocalDate toDob, @RequestParam(value = "alerts", required = false) @ApiParam("alert flags to filter by") final List<String> alerts,
            @RequestParam(value = "returnIep", required = false, defaultValue = "false") @ApiParam(value = "return IEP data", defaultValue = "false") final boolean returnIep, @RequestParam(value = "returnAlerts", required = false, defaultValue = "false") @ApiParam(value = "return Alert data", defaultValue = "false") final boolean returnAlerts, @RequestParam(value = "returnCategory", defaultValue = "false") @ApiParam(value = "retrieve category classification from assessments", defaultValue = "false") final boolean returnCategory, @RequestParam(value = "convictedStatus", defaultValue = "All") @ApiParam(value = "retrieve inmates with a specific convicted status (Convicted, Remand, default: All)", defaultValue = "All") final String convictedStatus,
            @RequestHeader(value = "Page-Offset", defaultValue = "0", required = false) @ApiParam(value = "Requested offset of first record in returned collection of inmate records.", defaultValue = "0") final Long pageOffset, @RequestHeader(value = "Page-Limit", defaultValue = "10", required = false) @ApiParam(value = "Requested limit to number of inmate records returned.", defaultValue = "10") final Long pageLimit, @RequestHeader(value = "Sort-Fields", defaultValue = "lastName,firstName,bookingId", required = false) @ApiParam("Comma separated list of one or more of the following fields - <b>bookingNo, bookingId, offenderNo, firstName, lastName, agencyId, or assignedLivingUnitId</b>") final String sortFields, @RequestHeader(value = "Sort-Order", defaultValue = "ASC", required = false) @ApiParam(value = "Sort order (ASC or DESC) - defaults to ASC.", defaultValue = "ASC") final Order sortOrder) {
