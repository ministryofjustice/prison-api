...
import net.syscon.prison.api.model.CategorisationUpdateDetail;
import net.syscon.prison.api.model.CategoryApprovalDetail;
import net.syscon.prison.api.model.CategoryRejectionDetail;
...
import net.syscon.prison.api.support.AssessmentStatusType;
...
import net.syscon.prison.service.support.InmateDto;
import net.syscon.prison.service.support.InmatesHelper;
...
import static net.syscon.prison.service.support.InmatesHelper.deriveClassification;
import static net.syscon.prison.service.support.InmatesHelper.deriveClassificationCode;
...
public class InmateService {
    ...
    private void validate(CategorisationDetail detail) {
        try {
            referenceDomainService.getReferenceCodeByDomainAndCode(net.syscon.prison.service.support.ReferenceDomain.CATEGORY.getDomain(),
                    detail.getCategory(), false);
        } catch (final EntityNotFoundException ex) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Category not recognised.");
        }
        try {
            referenceDomainService.getReferenceCodeByDomainAndCode(net.syscon.prison.service.support.ReferenceDomain.ASSESSMENT_COMMITTEE_CODE.getDomain(),
    ...
    private void validate(CategorisationUpdateDetail detail) {
        ...
        if (detail.getCommittee() != null) {
            try {
                referenceDomainService.getReferenceCodeByDomainAndCode(net.syscon.prison.service.support.ReferenceDomain.ASSESSMENT_COMMITTEE_CODE.getDomain(), detail.getCommittee(), false);
            } catch (final EntityNotFoundException ex) {
                throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Committee Code not recognised.");
            }
        }
    ...
    private void validate(final CategoryApprovalDetail detail) {
        try {
            referenceDomainService.getReferenceCodeByDomainAndCode(net.syscon.prison.service.support.ReferenceDomain.CATEGORY.getDomain(), detail.getCategory(), false);
        } catch (final EntityNotFoundException ex) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Category not recognised.");
        }
        try {
            referenceDomainService.getReferenceCodeByDomainAndCode(net.syscon.prison.service.support.ReferenceDomain.ASSESSMENT_COMMITTEE_CODE.getDomain(), detail.getReviewCommitteeCode(), false);
        } catch (final EntityNotFoundException ex) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Committee Code not recognised.");
        }
