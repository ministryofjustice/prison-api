...
import net.syscon.elite.aop.connectionproxy.OracleConnectionAspect;
import net.syscon.elite.aop.connectionproxy.RoleConfigurer;
import net.syscon.elite.aop.connectionproxy.RolePasswordSupplier;
