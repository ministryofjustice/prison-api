...
public class SentenceDetail extends BaseSentenceDetail {
    ...
    @ApiModelProperty(value = "Release date for non-DTO sentence (if applicable). This will be based on one of ARD, CRD, NPD or PRRD.", position = 45, example = "2020-04-01")
