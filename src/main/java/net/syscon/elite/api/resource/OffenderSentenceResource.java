...
public interface OffenderSentenceResource {
    ...
    class GetOffenderSentencesResponse extends ResponseDelegate {
        ...
        private GetOffenderSentencesResponse(Response response) { super(response); }
        private GetOffenderSentencesResponse(Response response, Object entity) { super(response, entity); }
    ...
    class GetOffenderSentencesHomeDetentionCurfewCandidatesResponse extends ResponseDelegate {
        ...
        private GetOffenderSentencesHomeDetentionCurfewCandidatesResponse(Response response) { super(response); }
        private GetOffenderSentencesHomeDetentionCurfewCandidatesResponse(Response response, Object entity) { super(response, entity); }
    ...
    class PostOffenderSentencesResponse extends ResponseDelegate {
        ...
        private PostOffenderSentencesResponse(Response response) { super(response); }
        private PostOffenderSentencesResponse(Response response, Object entity) { super(response, entity); }
    ...
    class PostOffenderSentencesBookingsResponse extends ResponseDelegate {
        ...
        private PostOffenderSentencesBookingsResponse(Response response) { super(response); }
        private PostOffenderSentencesBookingsResponse(Response response, Object entity) { super(response, entity); }
