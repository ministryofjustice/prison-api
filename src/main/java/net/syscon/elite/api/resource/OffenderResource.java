...
public interface OffenderResource {
    ...
    Response getOffenderCaseNotes(@ApiParam(value = "The booking id of offender", required = true) @PathParam("offenderNo") String offenderNo,
    ...
    @GET
    @Path("/{offenderNo}/caseNotes/{caseNoteId}")
    @Consumes({"application/json"})
    @Produces({"application/json"})
    ...
    CaseNote getOffenderCaseNote(@ApiParam(value = "The booking id of offender", required = true) @PathParam("offenderNo") String offenderNo,
    ...
    CaseNote createOffenderCaseNote(@ApiParam(value = "The offenderNo of offender", required = true) @PathParam("offenderNo") String offenderNo,
    ...
    CaseNote updateOffenderCaseNote(@ApiParam(value = "The booking id of offender", required = true, example = "1231212") @PathParam("offenderNo") String offenderNo,
