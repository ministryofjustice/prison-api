...
public interface AccessRoleResource {
    ...
    List<AccessRole> getAccessRoles(@ApiParam(value = "Include admin roles", required = true, defaultValue = "false") @RequestParam("includeAdmin") boolean includeAdmin);
    ...
    ResponseEntity<Void> createAccessRole(@ApiParam(value = "", required = true) AccessRole body);
    ...
    ResponseEntity<Void> updateAccessRole(@ApiParam(value = "", required = true) AccessRole body);
