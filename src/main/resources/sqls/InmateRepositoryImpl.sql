...
APPROVE_CATEGORY {
  update OFFENDER_ASSESSMENTS set
    ...
    --REVIEW_PLACE_AGY_LOC_ID=:agencyId,
    --REVIEW_PLACEMENT_TEXT=:reviewPlacementText,
    --NEXT_REVIEW_DATE=:nextReviewDate,
    REVIEW_SUP_LEVEL_TEXT=:reviewSupLevelText,
    ASSESSOR_STAFF_ID=:approverStaffId,
    MODIFY_USER_ID=:userId,
    MODIFY_DATETIME=:dateTime
  where OFFENDER_BOOK_ID=:bookingId
    and ASSESSMENT_SEQ=:seq
    and ASSESSMENT_TYPE_ID=(select ASSESSMENT_ID from ASSESSMENTS a where a.ASSESSMENT_CLASS='TYPE' and a.ASSESSMENT_CODE='CATEGORY')
    and ASSESS_STATUS='P'
}
...
OFFENDER_CATEGORY_SEQ_MAX {
  SELECT MAX (ASSESSMENT_SEQ) FROM OFFENDER_ASSESSMENTS OA
