...
FROM ( SELECT OIL.OFFENDER_BOOK_ID,
       ...
       WHERE OB.AGY_LOC_ID = :agencyId
         ...
         FULL OUTER JOIN (SELECT OCN.OFFENDER_BOOK_ID,
                          ...
                          WHERE OB.AGY_LOC_ID = :agencyId
                            AND OB.BOOKING_SEQ = :bookingSeq
                          GROUP BY  OCN.OFFENDER_BOOK_ID) POS_NEG_IEPS ON IEP_DETAILS.OFFENDER_BOOK_ID = POS_NEG_IEPS.OFFENDER_BOOK_ID
         FULL OUTER JOIN (
...
) PROVEN_ADJUDICATIONS ON IEP_DETAILS.OFFENDER_BOOK_ID = PROVEN_ADJUDICATIONS.OFFENDER_BOOK_ID
