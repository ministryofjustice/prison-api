...
GET_OFFENDER_SENT_CALCULATIONS {
  SELECT OB.OFFENDER_BOOK_ID                                     BOOKING_ID,
         ...
         COALESCE(ARD_OVERRIDED_DATE, ARD_CALCULATED_DATE)       ARD,
         COALESCE(CRD_OVERRIDED_DATE, CRD_CALCULATED_DATE)       CRD,
         COALESCE(NPD_OVERRIDED_DATE, NPD_CALCULATED_DATE)       NPD,
         COALESCE(PRRD_OVERRIDED_DATE, PRRD_CALCULATED_DATE)     PRRD,
