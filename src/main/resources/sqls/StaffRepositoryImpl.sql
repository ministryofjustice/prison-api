...
GET_STAFF_EMAIL_ADDRESSES {
  ...
  FROM INTERNET_ADDRESSES I
    INNER JOIN STAFF_USER_ACCOUNTS S ON I.OWNER_ID = S.STAFF_ID AND I.OWNER_CLASS = 'STF'
  WHERE I.INTERNET_ADDRESS_CLASS = 'EMAIL' and S.STAFF_ID = :staffId
  ORDER BY I.OWNER_SEQ
}
