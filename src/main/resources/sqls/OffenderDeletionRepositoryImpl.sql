...
DELETE FROM ASSESSMENT_SECTION_SCORES_V1 WHERE OFFENDER_BOOK_ID IN (:bookIds)
}

OD_DELETE_ASSESSMENT_SUMMARIES {
DELETE FROM ASSESSMENT_SUMMARIES WHERE OFFENDER_BOOK_ID IN (:bookIds)
}

OD_DELETE_ASSIGNMENTS {
DELETE FROM ASSIGNMENTS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}

OD_DELETE_ASSIGNMENT_TRANSFERS {
DELETE FROM ASSIGNMENT_TRANSFERS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}

OD_DELETE_CASEWORK_STEPS {
DELETE FROM CASEWORK_STEPS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}
...
DELETE FROM CASE_NOTES WHERE OFFENDER_BOOK_ID IN (:bookIds)
}

OD_DELETE_CASE_PLANS {
DELETE FROM CASE_PLANS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}

OD_DELETE_COURT_EVENT_SENTENCES {
DELETE FROM COURT_EVENT_SENTENCES WHERE OFFENDER_BOOK_ID IN (:bookIds)
}

OD_DELETE_EXT_OWNERSHIP_TRANSFER {
DELETE FROM EXT_OWNERSHIP_TRANSFER WHERE OFFENDER_BOOK_ID IN (:bookIds)
}

OD_DELETE_GT_MULTIPLE_FAILURE_ADJ {
DELETE FROM GT_MULTIPLE_FAILURE_ADJ WHERE OFFENDER_BOOK_ID IN (:bookIds)
}

OD_DELETE_GT_OFFENDER_SENTENCES {
DELETE FROM GT_OFFENDER_SENTENCES WHERE OFFENDER_BOOK_ID IN (:bookIds)
}

OD_DELETE_GT_OFFENDER_SENT_CALCULATIONS {
DELETE FROM GT_OFFENDER_SENT_CALCULATIONS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}
...
DELETE FROM NOTIFY_MOVEMENT_TYPES WHERE OFFENDER_BOOK_ID IN (:bookIds)
}

OD_DELETE_OFF_ASSMNT_ANSWERS {
DELETE FROM OFF_ASSMNT_ANSWERS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}

OD_DELETE_OFF_ASSMNT_BOOKLETS {
DELETE FROM OFF_ASSMNT_BOOKLETS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}

OD_DELETE_PLAN_DETAILS {
DELETE FROM PLAN_DETAILS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}

OD_DELETE_PURGED_OFFENDER_HISTORIES {
DELETE FROM PURGED_OFFENDER_HISTORIES WHERE OFFENDER_BOOK_ID IN (:bookIds)
}

OD_DELETE_STAFF_WORKS {
DELETE FROM STAFF_WORKS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}
...
DELETE FROM WORK_ASSIGNMENTS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}
...
DELETE FROM OFFENDER_AUTHORISED_VISITORS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}
...
DELETE FROM OFFENDER_CHARGE_SCHEDULES WHERE OFFENDER_BOOK_ID IN (:bookIds)
}

OD_DELETE_OFFENDER_CHK_LIST_DETAILS {
DELETE FROM OFFENDER_CHK_LIST_DETAILS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}

OD_DELETE_OFFENDER_CLOTHING_ISSUE {
DELETE FROM OFFENDER_CLOTHING_ISSUE WHERE OFFENDER_BOOK_ID IN (:bookIds)
}

OD_DELETE_OFFENDER_CLOTHING_ITEMS {
DELETE FROM OFFENDER_CLOTHING_ITEMS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}

OD_DELETE_OFFENDER_COMM_SUP_HISTORIES {
DELETE FROM OFFENDER_COMM_SUP_HISTORIES WHERE OFFENDER_BOOK_ID IN (:bookIds)
}
...
DELETE FROM OFFENDER_DRUG_ADMISSIONS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}

OD_DELETE_OFFENDER_DRUG_SAMPLES {
DELETE FROM OFFENDER_DRUG_SAMPLES WHERE OFFENDER_BOOK_ID IN (:bookIds)
}
...
DELETE FROM OFFENDER_ESCAPES WHERE OFFENDER_BOOK_ID IN (:bookIds)
}

OD_DELETE_OFFENDER_FILE_LOCATIONS {
DELETE FROM OFFENDER_FILE_LOCATIONS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}
...
DELETE FROM OFFENDER_INTERNAL_MOVEMENTS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}

OD_DELETE_OFFENDER_INTERNAL_STATUSES {
DELETE FROM OFFENDER_INTERNAL_STATUSES WHERE OFFENDER_BOOK_ID IN (:bookIds)
}

OD_DELETE_OFFENDER_INTERVENTION_TIERS {
DELETE FROM OFFENDER_INTERVENTION_TIERS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}
...
DELETE FROM OFFENDER_NOT_COMPLETIONS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}
...
DELETE FROM OFFENDER_OASYS_CONCERNS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}

OD_DELETE_OFFENDER_OASYS_OBJECTIVES {
DELETE FROM OFFENDER_OASYS_OBJECTIVES WHERE OFFENDER_BOOK_ID IN (:bookIds)
}

OD_DELETE_OFFENDER_OASYS_PLANS {
DELETE FROM OFFENDER_OASYS_PLANS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}

OD_DELETE_OFFENDER_OASYS_RISK_TO_OTHERS {
DELETE FROM OFFENDER_OASYS_RISK_TO_OTHERS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}

OD_DELETE_OFFENDER_OASYS_SECTIONS {
DELETE FROM OFFENDER_OASYS_SECTIONS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}
...
DELETE FROM OFFENDER_PEND_NOTIFICATIONS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}

OD_DELETE_OFFENDER_POST_DATED_TXNS {
DELETE FROM OFFENDER_POST_DATED_TXNS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}
...
DELETE FROM OFFENDER_PPTY_ITEMS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}

OD_DELETE_OFFENDER_PPTY_ITEM_EVENTS {
DELETE FROM OFFENDER_PPTY_ITEM_EVENTS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}

OD_DELETE_OFFENDER_PPTY_ITEM_TXNS {
DELETE FROM OFFENDER_PPTY_ITEM_TXNS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}

OD_DELETE_OFFENDER_PROCEEDINGS {
DELETE FROM OFFENDER_PROCEEDINGS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}

OD_DELETE_OFFENDER_PROCEEDING_SENTS {
DELETE FROM OFFENDER_PROCEEDING_SENTS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}
...
DELETE FROM OFFENDER_RELEASE_NOTIS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}
...
DELETE FROM OFFENDER_REQUESTS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}

OD_DELETE_OFFENDER_REQUESTS_HTY {
DELETE FROM OFFENDER_REQUESTS_HTY WHERE OFFENDER_BOOK_ID IN (:bookIds)
}
...
DELETE FROM OFFENDER_SCHEDULE_PERSONS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}
...
DELETE FROM OFFENDER_SENTENCE_HTY WHERE OFFENDER_BOOK_ID IN (:bookIds)
}
...
DELETE FROM OFFENDER_SUBSTANCE_ABUSES WHERE OFFENDER_BOOK_ID IN (:bookIds)
}
...
DELETE FROM OFFENDER_TELEPHONES WHERE OFFENDER_BOOK_ID IN (:bookIds)
}
...
DELETE FROM OFFENDER_TREATMENTS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}
...
DELETE FROM OFFENDER_UNPAID_WORK_ADJ WHERE OFFENDER_BOOK_ID IN (:bookIds)
}

OD_DELETE_OFFENDER_VICTIMS {
DELETE FROM OFFENDER_VICTIMS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}
...
DELETE FROM OFFENDER_WORKS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}

OD_DELETE_OFFENDER_WORK_ASSIGNMENTS {
DELETE FROM OFFENDER_WORK_ASSIGNMENTS WHERE OFFENDER_BOOK_ID IN (:bookIds)
}
