...
FROM OFFENDER_CHARGES OCH
   ...
   LEFT JOIN COURT_EVENT_CHARGES CEC on CEC.OFFENDER_CHARGE_ID = OCH.OFFENDER_CHARGE_ID
   LEFT JOIN COURT_EVENTS CE on CEC.EVENT_ID = CE.EVENT_ID
