...
CONSTRAINT QUE_QUE_QUE_FK FOREIGN KEY (QUESTIONNAIRE_ID) REFERENCES QUESTIONNAIRES(QUESTIONNAIRE_ID)
);
CREATE INDEX QUESTIONNAIRE_QUESTIONS_NI1 ON QUESTIONNAIRE_QUESTIONS (QUESTIONNAIRE_ID);
