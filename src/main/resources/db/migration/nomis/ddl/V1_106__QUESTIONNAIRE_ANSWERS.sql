...
(
  ...
  CONSTRAINT QUE_ANS_QUE_QUE_FK1 FOREIGN KEY (QUESTIONNAIRE_QUE_ID) REFERENCES QUESTIONNAIRE_QUESTIONS(QUESTIONNAIRE_QUE_ID),
  CONSTRAINT QUE_ANS_QUE_QUE_FK2 FOREIGN KEY (NEXT_QUESTIONNAIRE_QUE_ID) REFERENCES QUESTIONNAIRE_QUESTIONS(QUESTIONNAIRE_QUE_ID)
);
