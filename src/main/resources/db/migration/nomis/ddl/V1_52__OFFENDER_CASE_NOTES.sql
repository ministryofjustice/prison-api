...
(
  ...
  "AUDIT_TIMESTAMP"               TIMESTAMP(9) DEFAULT systimestamp,
  "AUDIT_USER_ID"                 VARCHAR2(32 CHAR) DEFAULT USER,
...
CREATE INDEX "OFFENDER_CASE_NOTES_X05"
  ON "OFFENDER_CASE_NOTES" ("AGY_LOC_ID", "OFFENDER_BOOK_ID");
