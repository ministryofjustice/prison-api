  ...
  CREATE TABLE "OFFENDER_VSC_SENTENCES"
   (    "OFFENDER_BOOK_ID" NUMBER(10,0) NOT NULL,
    ...
    "DPRRD_CALCULATED_DATE" DATE,
     CONSTRAINT "OFFENDER_VSC_SENTENCES_PK" PRIMARY KEY ("OFFENDER_BOOK_ID", "SENTENCE_SEQ"),
  );

  CREATE INDEX "OFFENDER_VSC_SENTENCES_NI1" ON "OFFENDER_VSC_SENTENCES" ("ORDER_ID");


  CREATE INDEX "OFFENDER_VSC_SENTENCES_NI2" ON "OFFENDER_VSC_SENTENCES" ("SENTENCE_CATEGORY", "SENTENCE_CALC_TYPE");


  CREATE INDEX "OFFENDER_VSC_SENTENCES_NI3" ON "OFFENDER_VSC_SENTENCES" ("CASE_ID");


  CREATE INDEX "OFFENDER_VSC_SENTENCES_NI4" ON "OFFENDER_VSC_SENTENCES" ("REVOKED_STAFF_ID");


  CREATE INDEX "OFFENDER_VSC_SENTENCES_NI5" ON "OFFENDER_VSC_SENTENCES" ("START_DATE");


  CREATE INDEX "OFFENDER_VSC_SENTENCES_NI6" ON "OFFENDER_VSC_SENTENCES" ("END_DATE");


  CREATE UNIQUE INDEX "OFFENDER_VSC_SENTENCES_PK" ON "OFFENDER_VSC_SENTENCES" ("OFFENDER_BOOK_ID", "SENTENCE_SEQ");
