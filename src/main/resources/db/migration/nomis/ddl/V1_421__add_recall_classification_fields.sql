...
ALTER TABLE SENTENCE_CALC_TYPES ADD IS_RECALLABLE VARCHAR(1) DEFAULT 'N' NOT NULL;
...
ALTER TABLE OFFENDER_SENTENCES ADD IS_RECALLABLE VARCHAR(1) DEFAULT 'N' NOT NULL;
