  ...
  CREATE TABLE "CURFEW_ADDRESSES"
   (    "CURFEW_ADDRESS_ID" NUMBER(10,0) NOT NULL,
    ...
    CONSTRAINT CURFEW_ADDRESSES_FK9 FOREIGN KEY (OFFENDER_BOOK_ID) REFERENCES OFFENDER_BOOKINGS(OFFENDER_BOOK_ID),
    CONSTRAINT CURFEW_ADDR_OFF_CURFEW_FK FOREIGN KEY (OFFENDER_CURFEW_ID) REFERENCES OFFENDER_CURFEWS(OFFENDER_CURFEW_ID),
    CONSTRAINT CUR_ADDR_ADDR_FK FOREIGN KEY (ADDRESS_ID) REFERENCES ADDRESSES(ADDRESS_ID)
  );
