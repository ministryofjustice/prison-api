...
INSERT INTO COURSE_ACTIVITIES (CRS_ACTY_ID, CASELOAD_ID, AGY_LOC_ID, DESCRIPTION, CAPACITY, ACTIVE_FLAG, SCHEDULE_START_DATE, CASELOAD_TYPE, PROGRAM_ID, INTERNAL_LOCATION_ID, PROVIDER_PARTY_CLASS, PROVIDER_PARTY_CODE, CODE, COURSE_ACTIVITY_TYPE, IEP_LEVEL, SCHEDULE_END_DATE)
VALUES (-2,  'LEI',  'LEI', 'Woodwork', 10, 'Y', TO_DATE('2012-02-28', 'YYYY-MM-DD'), 'INST', -2, -26, 'AGY',  'LEI', 'WOOD', 'EDUC', 'STD', TO_DATE('2021-08-09', 'YYYY-MM-DD'));
