...
VALUES (-26, -2, trunc(sysdate), trunc(sysdate) + INTERVAL '12' HOUR, trunc(sysdate) + INTERVAL '12' HOUR, 'SCH');
INSERT INTO COURSE_SCHEDULES (CRS_SCH_ID, CRS_ACTY_ID, SCHEDULE_DATE, START_TIME, END_TIME, SCHEDULE_STATUS)
VALUES (-27, -2, trunc(sysdate), trunc(sysdate) + INTERVAL '13' HOUR, trunc(sysdate) + INTERVAL '13' HOUR, 'SCH');
INSERT INTO COURSE_SCHEDULES (CRS_SCH_ID, CRS_ACTY_ID, SCHEDULE_DATE, START_TIME, END_TIME, SCHEDULE_STATUS)
VALUES (-28, -5, trunc(sysdate) + INTERVAL  '6' DAY, trunc(sysdate) + INTERVAL  '6' DAY,
        trunc(sysdate) + INTERVAL  '6' DAY, 'SCH');
INSERT INTO COURSE_SCHEDULES (CRS_SCH_ID, CRS_ACTY_ID, SCHEDULE_DATE, START_TIME, END_TIME, SCHEDULE_STATUS)
VALUES (-29, -6, trunc(sysdate) + INTERVAL  '3' DAY, trunc(sysdate) + INTERVAL  '3' DAY,
        trunc(sysdate) + INTERVAL  '3' DAY, 'SCH');
INSERT INTO COURSE_SCHEDULES (CRS_SCH_ID, CRS_ACTY_ID, SCHEDULE_DATE, START_TIME, END_TIME, SCHEDULE_STATUS)
VALUES (-30, -5, trunc(sysdate) + INTERVAL '17' DAY, trunc(sysdate) + INTERVAL '17' DAY,
        trunc(sysdate) + INTERVAL '17' DAY, 'SCH');
INSERT INTO COURSE_SCHEDULES (CRS_SCH_ID, CRS_ACTY_ID, SCHEDULE_DATE, START_TIME, END_TIME, SCHEDULE_STATUS)
VALUES (-31, -6, trunc(sysdate) + INTERVAL  '9' DAY, trunc(sysdate) + INTERVAL  '9' DAY,
        trunc(sysdate) + INTERVAL  '9' DAY, 'SCH');

INSERT INTO COURSE_SCHEDULES (CRS_SCH_ID, CRS_ACTY_ID, SCHEDULE_DATE, START_TIME, END_TIME, SCHEDULE_STATUS)
VALUES (-34, -2, trunc(sysdate), trunc(sysdate) + 10 / 24, trunc(sysdate) + 12 / 24, 'SCH');

INSERT INTO COURSE_SCHEDULES (CRS_SCH_ID, CRS_ACTY_ID, SCHEDULE_DATE, START_TIME, END_TIME, SCHEDULE_STATUS)
VALUES (-35, -4, TO_DATE('1985-01-01', 'YYYY-MM-DD'), TO_DATE('1985-01-01 13:10:00', 'YYYY-MM-DD HH24:MI:SS'),
        TO_DATE('1985-01-01 15:00:00', 'YYYY-MM-DD HH24:MI:SS'), 'SCH');
