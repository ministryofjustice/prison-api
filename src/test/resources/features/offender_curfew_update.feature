Feature: Updating Offender Curfew state
  ...
  Scenario Outline:  Update the 'Approval status' for a booking's current (latest) curfew
    ...
    Examples:
      ...
      | SYSTEM_USER_READ_WRITE | -35       | true         | APPROVED       |               | 2018-01-31         | 200        |
      | SYSTEM_USER_READ_WRITE | -35       | true         | INELIGIBLE     | BREACH        | 2018-01-31         | 200        |
      | SYSTEM_USER_READ_WRITE | -35       | true         | OPT_OUT        | BREACH        | 2018-01-31         | 200        |
      | SYSTEM_USER_READ_WRITE | -35       | true         | OPT_OUT ACCO   | BREACH        | 2018-01-31         | 200        |
      | SYSTEM_USER_READ_WRITE | -35       | true         | OPT_OUT OTH    | BREACH        | 2018-01-31         | 200        |
      | SYSTEM_USER_READ_WRITE | -35       | true         | PP INVEST      | BREACH        | 2018-01-31         | 200        |
      | SYSTEM_USER_READ_WRITE | -35       | true         | PP OUT RISK    | BREACH        | 2018-01-31         | 200        |
      | SYSTEM_USER_READ_WRITE | -35       | true         | PRES UNSUIT    | BREACH        | 2018-01-31         | 200        |
      | SYSTEM_USER_READ_WRITE | -35       | true         | REJECTED       | BREACH        | 2018-01-31         | 200        |
      | SYSTEM_USER_READ_WRITE | -35       | true         | REJECTED       | ADDRESS       | 2018-01-31         | 200        |
      | SYSTEM_USER_READ_WRITE | -35       | false        | INELIGIBLE     | BREACH        | 2018-01-31         | 200        |
      | SYSTEM_USER_READ_WRITE | -35       | false        | OPT_OUT        | BREACH        | 2018-01-31         | 200        |
      | SYSTEM_USER_READ_WRITE | -35       | false        | OPT_OUT ACCO   | BREACH        | 2018-01-31         | 200        |
      | SYSTEM_USER_READ_WRITE | -35       | false        | OPT_OUT OTH    | BREACH        | 2018-01-31         | 200        |
      | SYSTEM_USER_READ_WRITE | -35       | false        | PP INVEST      | BREACH        | 2018-01-31         | 200        |
      | SYSTEM_USER_READ_WRITE | -35       | false        | PP OUT RISK    | BREACH        | 2018-01-31         | 200        |
      | SYSTEM_USER_READ_WRITE | -35       | false        | PRES UNSUIT    | BREACH        | 2018-01-31         | 200        |
      | SYSTEM_USER_READ_WRITE | -35       | false        | REJECTED       | BREACH        | 2018-01-31         | 200        |
      | SYSTEM_USER_READ_WRITE | -35       | false        | REJECTED       | ADDRESS       | 2018-01-31         | 200        |
