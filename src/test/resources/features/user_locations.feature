Feature: User Locations
  ...
  Scenario Outline: Retrieve user locations
    ...
    Examples:
      ...
      | NORMAL_USER   | 11     | LEI,LEI,LEI,LEI,LEI,LEI,LEI,LEI,LEI,LEI,LEI     | Block A,C,Cswap,D,E,F,H,I,Leeds,Recp,S         | LEI,LEI-A,LEI-C,LEI-CSWAP,LEI-D,LEI-E,LEI-F,LEI-H,LEI-I,LEI-RECP,LEI-S     |
      | API_TEST_USER | 12     | BXI,LEI,LEI,LEI,LEI,LEI,LEI,LEI,LEI,LEI,LEI,LEI | Block A,Brixton,C,Cswap,D,E,F,H,I,Leeds,Recp,S | BXI,LEI,LEI-A,LEI-C,LEI-CSWAP,LEI-D,LEI-E,LEI-F,LEI-H,LEI-I,LEI-RECP,LEI-S |