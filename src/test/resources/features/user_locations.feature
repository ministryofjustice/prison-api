Feature: User Locations
  ...
  Scenario Outline: Retrieve user locations
    ...
    Examples:
      ...
      | NORMAL_USER   | 13     | LEI,LEI,LEI,LEI,LEI,LEI,LEI,LEI,LEI,LEI,LEI,LEI,LEI     | Block A,C,Court,Cswap,D,E,F,H,I,Leeds,Recp,S,Tap         | LEI,LEI-A,LEI-C,LEI-COURT,LEI-CSWAP,LEI-D,LEI-E,LEI-F,LEI-H,LEI-I,LEI-RECP,LEI-S,LEI-TAP     |
      | API_TEST_USER | 14     | BXI,LEI,LEI,LEI,LEI,LEI,LEI,LEI,LEI,LEI,LEI,LEI,LEI,LEI | Block A,Brixton,C,Court,Cswap,D,E,F,H,I,Leeds,Recp,S,Tap | BXI,LEI,LEI-A,LEI-C,LEI-COURT,LEI-CSWAP,LEI-D,LEI-E,LEI-F,LEI-H,LEI-I,LEI-RECP,LEI-S,LEI-TAP |