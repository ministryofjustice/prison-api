...
public class OffenderResourceIntTest_getOffenderAlerts extends ResourceTest {
    ...
    relevant data is as follows:
        ...
        INSERT INTO OFFENDER_ALERTS (ALERT_DATE, OFFENDER_BOOK_ID, ROOT_OFFENDER_ID, ALERT_SEQ, ALERT_TYPE, ALERT_CODE, ALERT_STATUS, VERIFIED_FLAG, EXPIRY_DATE, COMMENT_TEXT, CASELOAD_ID, CASELOAD_TYPE, MODIFY_DATETIME) VALUES (DATE '2021-07-21', -35, -1035, 2, 'V', 'VOP', 'INACTIVE', 'N', sysdate, '', 'LEI', 'INST', TIMESTAMP '2006-12-10 03:52:25.0');
    ...
    */
    ...
    class LegacyUnSafeEndpoint {
        ...
        @Test
        @DisplayName("will show alerts for the latest booking order by alert type of an offender when latest only set to true")
