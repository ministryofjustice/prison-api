...
import uk.gov.justice.hmpps.nomis.prison.datacompliance.repository.OffenderPendingDeletionRepository;
import uk.gov.justice.hmpps.nomis.prison.datacompliance.repository.jpa.model.OffenderAliasPendingDeletion;
import uk.gov.justice.hmpps.nomis.prison.datacompliance.repository.jpa.model.OffenderBookingPendingDeletion;
import uk.gov.justice.hmpps.nomis.prison.datacompliance.repository.jpa.model.OffenderChargePendingDeletion;
    ...
    public void acceptOffendersPendingDeletion() throws Exception {
        ...
        when(offenderPendingDeletionRepository
                ...
                .thenReturn(new PageImpl<>(List.of(
                        new uk.gov.justice.hmpps.nomis.prison.datacompliance.repository.jpa.model.OffenderPendingDeletion(OFFENDER_NUMBER_1),
                        new uk.gov.justice.hmpps.nomis.prison.datacompliance.repository.jpa.model.OffenderPendingDeletion(OFFENDER_NUMBER_2)),
