...
class OffenderSentConditionsRepositoryTest {
    ...
    public void findChildRelatedConditionsByBookings(){
        ...
        assertThat(conditions).extracting(OffenderSentConditions::getGroomingFlag).containsOnly("N");
        assertThat(conditions).extracting(OffenderSentConditions::getNoWorkWithUnderAge).containsOnly("Y");
    }
