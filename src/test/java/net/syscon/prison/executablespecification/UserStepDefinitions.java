...
import static net.syscon.prison.executablespecification.steps.AuthTokenHelper.AuthToken.ADMIN_TOKEN;
import static net.syscon.prison.executablespecification.steps.AuthTokenHelper.AuthToken.CATEGORISATION_CREATE;
import static net.syscon.prison.executablespecification.steps.AuthTokenHelper.AuthToken.GLOBAL_SEARCH;
import static net.syscon.prison.executablespecification.steps.AuthTokenHelper.AuthToken.LOCAL_ADMIN;
import static net.syscon.prison.executablespecification.steps.AuthTokenHelper.AuthToken.NORMAL_USER;
import static net.syscon.prison.executablespecification.steps.AuthTokenHelper.AuthToken.PAY;
