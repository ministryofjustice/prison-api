...
import net.syscon.prison.repository.v1.model.AccountTransactionSP;
import net.syscon.prison.repository.v1.model.AliasSP;
import net.syscon.prison.repository.v1.model.AvailableDatesSP;
import net.syscon.prison.repository.v1.model.ContactPersonSP;
import net.syscon.prison.repository.v1.model.EventSP;
import net.syscon.prison.repository.v1.model.HoldSP;
import net.syscon.prison.repository.v1.model.LiveRollSP;
import net.syscon.prison.repository.v1.model.OffenderSP;
import net.syscon.prison.repository.v1.model.UnavailabilityReasonSP;
import net.syscon.prison.repository.v1.model.VisitSlotsSP;
import net.syscon.prison.repository.v1.storedprocs.EventProcs.GetEvents;
import net.syscon.prison.repository.v1.storedprocs.FinanceProcs.GetAccountBalances;
import net.syscon.prison.repository.v1.storedprocs.FinanceProcs.GetAccountTransactions;
import net.syscon.prison.repository.v1.storedprocs.FinanceProcs.GetHolds;
import net.syscon.prison.repository.v1.storedprocs.FinanceProcs.GetTransactionByClientUniqueRef;
import net.syscon.prison.repository.v1.storedprocs.FinanceProcs.PostStorePayment;
import net.syscon.prison.repository.v1.storedprocs.FinanceProcs.PostTransaction;
import net.syscon.prison.repository.v1.storedprocs.FinanceProcs.PostTransfer;
import net.syscon.prison.repository.v1.storedprocs.OffenderProcs.GetOffenderDetails;
import net.syscon.prison.repository.v1.storedprocs.OffenderProcs.GetOffenderImage;
import net.syscon.prison.repository.v1.storedprocs.OffenderProcs.GetOffenderPssDetail;
import net.syscon.prison.repository.v1.storedprocs.PrisonProcs.GetLiveRoll;
...
import static net.syscon.prison.repository.v1.storedprocs.StoreProcMetadata.P_CASH_BALANCE;
import static net.syscon.prison.repository.v1.storedprocs.StoreProcMetadata.P_CLIENT_UNIQUE_REF;
import static net.syscon.prison.repository.v1.storedprocs.StoreProcMetadata.P_CONTACT_CSR;
import static net.syscon.prison.repository.v1.storedprocs.StoreProcMetadata.P_CURRENT_AGY_DESC;
import static net.syscon.prison.repository.v1.storedprocs.StoreProcMetadata.P_CURRENT_AGY_LOC_ID;
import static net.syscon.prison.repository.v1.storedprocs.StoreProcMetadata.P_DATE_CSR;
import static net.syscon.prison.repository.v1.storedprocs.StoreProcMetadata.P_DETAILS_CLOB;
import static net.syscon.prison.repository.v1.storedprocs.StoreProcMetadata.P_EVENTS_CSR;
import static net.syscon.prison.repository.v1.storedprocs.StoreProcMetadata.P_HOLDS_CSR;
import static net.syscon.prison.repository.v1.storedprocs.StoreProcMetadata.P_IMAGE;
import static net.syscon.prison.repository.v1.storedprocs.StoreProcMetadata.P_NOMS_ID;
import static net.syscon.prison.repository.v1.storedprocs.StoreProcMetadata.P_OFFENDER_CSR;
import static net.syscon.prison.repository.v1.storedprocs.StoreProcMetadata.P_REASON_CSR;
...
import static net.syscon.prison.repository.v1.storedprocs.StoreProcMetadata.P_SAVINGS_BALANCE;
import static net.syscon.prison.repository.v1.storedprocs.StoreProcMetadata.P_SINGLE_OFFENDER_ID;
import static net.syscon.prison.repository.v1.storedprocs.StoreProcMetadata.P_SPENDS_BALANCE;
import static net.syscon.prison.repository.v1.storedprocs.StoreProcMetadata.P_TIMESTAMP;
import static net.syscon.prison.repository.v1.storedprocs.StoreProcMetadata.P_TRANS_CSR;
import static net.syscon.prison.repository.v1.storedprocs.StoreProcMetadata.P_TXN_ENTRY_SEQ;
import static net.syscon.prison.repository.v1.storedprocs.StoreProcMetadata.P_TXN_ID;
import static net.syscon.prison.repository.v1.storedprocs.VisitsProc.GetAvailableDates;
import static net.syscon.prison.repository.v1.storedprocs.VisitsProc.GetContactList;
import static net.syscon.prison.repository.v1.storedprocs.VisitsProc.GetUnavailability;
import static net.syscon.prison.repository.v1.storedprocs.VisitsProc.GetVisitSlotsWithCapacity;
