...
(
  ...
  PROGRAM_CATEGORY         VARCHAR2(12),
  PROGRAM_CODE             VARCHAR2(40),
  DESCRIPTION              VARCHAR2(40)                       NOT NULL,
  ACTIVE_FLAG              VARCHAR2(1)                        NOT NULL,
  EXPIRY_DATE              DATE,
  COMMENT_TEXT             VARCHAR2(240),
  PROGRAM_CLASS            VARCHAR2(12)                       NOT NULL ,
  PARENT_PROGRAM_ID        NUMBER(10),
  CONTACT_METHOD           VARCHAR2(80),
  NO_OF_SESSIONS           NUMBER(6),
  NO_OF_ALLOWABLE_RESTARTS NUMBER(6),
  NO_OF_ALLOWABLE_ABSENCES NUMBER(6),
  CAPACITY                 NUMBER(6),
  SESSION_LENGTH           NUMBER(6),
  COMPLETION_FLAG          VARCHAR2(1),
  MODULE_FLAG              VARCHAR2(1),
  MODULE_TYPE              VARCHAR2(12),
  BREAK_ALLOWED_FLAG       VARCHAR2(1),
  START_FLAG               VARCHAR2(1) DEFAULT 'N',
  NO_OF_WEEKLY_SESSIONS    NUMBER(6),
  PROGRAM_STATUS           VARCHAR2(12),
  LIST_SEQ                 NUMBER(6),
  PHASE_TYPE               VARCHAR2(12),
  START_DATE               DATE,
  END_DATE                 DATE,
  ...
  CONSTRAINT PROGRAM_SERVICES_CHK1 CHECK (PROGRAM_CLASS IN ('PRG', 'PRG_MOD', 'PRG_PH', 'PRG_BLK','MED_SCHED')),
  CONSTRAINT PRG_SERV_PRG_SERV_FK FOREIGN KEY (PARENT_PROGRAM_ID) REFERENCES PROGRAM_SERVICES(PROGRAM_ID)
);

-- create index PROGRAM_SERVICES_NI1
--   on PROGRAM_SERVICES (PROGRAM_CATEGORY);
--
-- create index PROGRAM_SERVICES_NI3
--   on PROGRAM_SERVICES (PROGRAM_CODE);
--
-- create index PROGRAM_SERVICES_NI2
--   on PROGRAM_SERVICES (PARENT_PROGRAM_ID);

COMMENT ON TABLE PROGRAM_SERVICES IS 'The Program Services details (includes Program Phases and Program Modules)';
