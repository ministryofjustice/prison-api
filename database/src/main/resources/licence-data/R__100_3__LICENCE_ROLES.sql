...
VALUES (ROLE_ID.NEXTVAL, 'Licence Roles', 1, 'LICENCE_ROLE', NULL, 'APP', 'GENERAL', 'Y');

INSERT INTO OMS_ROLES (ROLE_ID, ROLE_NAME, ROLE_SEQ, ROLE_CODE,
                       PARENT_ROLE_CODE, ROLE_TYPE, ROLE_FUNCTION, SYSTEM_DATA_FLAG)
VALUES (ROLE_ID.NEXTVAL, 'Licence Case Admin', 1, 'LICENCE_CA', 'LICENCE_ROLE', 'APP', 'GENERAL', 'Y');

INSERT INTO OMS_ROLES (ROLE_ID, ROLE_NAME, ROLE_SEQ, ROLE_CODE,
                       PARENT_ROLE_CODE, ROLE_TYPE, ROLE_FUNCTION, SYSTEM_DATA_FLAG)
VALUES
  (ROLE_ID.NEXTVAL, 'Licence Responsible Officer', 2, 'LICENCE_RO', 'LICENCE_ROLE', 'APP', 'GENERAL', 'Y');

INSERT INTO OMS_ROLES (ROLE_ID, ROLE_NAME, ROLE_SEQ, ROLE_CODE,
                       PARENT_ROLE_CODE, ROLE_TYPE, ROLE_FUNCTION, SYSTEM_DATA_FLAG)
VALUES (ROLE_ID.NEXTVAL, 'Licence Decision Maker', 3, 'LICENCE_DM', 'LICENCE_ROLE', 'APP', 'GENERAL', 'Y');
