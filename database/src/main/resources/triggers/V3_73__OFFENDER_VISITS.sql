CREATE OR REPLACE TRIGGER "OMS_OWNER"."OFFENDER_VISITS_TA"
  BEFORE INSERT OR UPDATE OR DELETE ON OFFENDER_VISITS
  ...
  BEGIN
    /*
    ============================================================
       Generated by 2.3  Date Generation 19-NOV-2008
    ============================================================
...
/
ALTER TRIGGER "OMS_OWNER"."OFFENDER_VISITS_TA" ENABLE;


CREATE OR REPLACE TRIGGER "OMS_OWNER"."OFFENDER_VISITS_T1"
  BEFORE
  INSERT OR UPDATE
  ON Offender_visits
  ...
  BEGIN
    ...
    /* MODIFICATION HISTORY
       ...
       David Ng     09/03/2006  1.0          New Offender Visits
    */
    IF (:new.VISIT_STATUS IS NOT NULL) THEN
      SELECT count(*) into v_numrows
      FROM   Reference_codes
      WHERE  Code = :new.Visit_Status
             AND    DOMAIN = 'VIS_STS';
