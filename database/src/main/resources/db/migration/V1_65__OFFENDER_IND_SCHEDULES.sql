...
(
  ...
  "EVENT_STATUS"                  VARCHAR2(12 CHAR)                 NOT NULL ENABLE,
  ...
  CONSTRAINT "OFFNDER_IND_SCHEDULE_CHK1" CHECK (event_class IN ('EXT_MOV', 'INT_MOV', 'COMM')) ENABLE,
  ...
  REFERENCES "OFFENDER_MOVEMENT_APPS" ("OFFENDER_MOVEMENT_APP_ID") ENABLE,
