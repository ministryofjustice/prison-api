...
(
  ...
  "PROGRAM_CLASS"                 VARCHAR2(12 CHAR)                 NOT NULL ENABLE,
  ...
  CONSTRAINT "PROGRAM_SERVICES_CHK1" CHECK (program_class IN ('PRG', 'PRG_MOD', 'PRG_PH', 'PRG_BLK') ) ENABLE,
  CONSTRAINT "PROGRAM_SERVICES_PK" PRIMARY KEY ("PROGRAM_ID"),
  CHECK ( active_flag IN ('N', 'Y')  ) ENABLE,
