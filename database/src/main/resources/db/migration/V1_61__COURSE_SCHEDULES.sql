...
(
  "CRS_SCH_ID"                    NUMBER(10, 0)                     NOT NULL ENABLE,
  "CRS_ACTY_ID"                   NUMBER(10, 0)                     NOT NULL ENABLE,
  "WEEKDAY"                       VARCHAR2(12 CHAR),
  "SCHEDULE_DATE"                 DATE                              NOT NULL ENABLE,
  ...
  CONSTRAINT "CRS_SCH_CRS_SCH_FK" FOREIGN KEY ("CATCH_UP_CRS_SCH_ID")
  REFERENCES "COURSE_SCHEDULES" ("CRS_SCH_ID") ON DELETE CASCADE ENABLE,
  CONSTRAINT "CSR_SCH_CRS_ACTY_FK" FOREIGN KEY ("CRS_ACTY_ID")
