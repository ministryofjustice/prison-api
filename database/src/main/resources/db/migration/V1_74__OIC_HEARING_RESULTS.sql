...
(
  "OIC_HEARING_ID"                NUMBER(10, 0)                     NOT NULL ENABLE,
  "RESULT_SEQ"                    NUMBER(6, 0)                      NOT NULL ENABLE,
  "AGENCY_INCIDENT_ID"            NUMBER(10, 0)                     NOT NULL ENABLE,
  "CHARGE_SEQ"                    NUMBER(6, 0)                      NOT NULL ENABLE,
  "PLEA_FINDING_CODE"             VARCHAR2(12 CHAR)                 NOT NULL ENABLE,
  "FINDING_CODE"                  VARCHAR2(12 CHAR)                 NOT NULL ENABLE,
  ...
  "OIC_OFFENCE_ID"                NUMBER(10, 0)                     NOT NULL ENABLE,
...
--  CONSTRAINT "OIC_HEARING_RESULTS_FK1" FOREIGN KEY ("OIC_OFFENCE_ID")
--  REFERENCES "OIC_OFFENCES" ("OIC_OFFENCE_ID") ENABLE NOVALIDATE,
--  CONSTRAINT "OIC_HR_OIC_HEAR_F1" FOREIGN KEY ("OIC_HEARING_ID")
--  REFERENCES "OIC_HEARINGS" ("OIC_HEARING_ID") ENABLE,
--  CONSTRAINT "OIC_HR_OIC_AGY_INC_CHG_FK" FOREIGN KEY ("AGENCY_INCIDENT_ID", "CHARGE_SEQ")
--  REFERENCES "AGENCY_INCIDENT_CHARGES" ("AGENCY_INCIDENT_ID", "CHARGE_SEQ")
);
