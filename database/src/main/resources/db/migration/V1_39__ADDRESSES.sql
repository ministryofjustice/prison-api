...
(
  ...
  "OWNER_CLASS"                   VARCHAR2(12 CHAR)                 NOT NULL ENABLE,
  ...
  "PRIMARY_FLAG"                  VARCHAR2(1 CHAR)                  NOT NULL ENABLE,
  "MAIL_FLAG"                     VARCHAR2(1 CHAR)                  NOT NULL ENABLE,
  "CAPACITY"                      NUMBER(5, 0),
...
CREATE INDEX "ADDRESSES_NI1"
  ON "ADDRESSES" ("OWNER_ID");


CREATE INDEX "ADDRESSES_NI2"
  ON "ADDRESSES" ("OWNER_CODE");


CREATE INDEX "ADDRESSES_NI3"
  ON "ADDRESSES" ("POSTAL_CODE");


CREATE INDEX "ADDRESSES_NI4"
  ON "ADDRESSES" ("CITY_CODE");


CREATE INDEX "ADDRESSES_NI5"
  ON "ADDRESSES" ("COUNTY_CODE");


CREATE INDEX "ADDRESSES_NI6"
  ON "ADDRESSES" (UPPER("STREET"));


CREATE INDEX "ADDRESSES_NI7"
  ON "ADDRESSES" (UPPER("LOCALITY"));
