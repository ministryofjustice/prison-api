...
(
  ...
  "LAST_NAME"                     VARCHAR2(35 CHAR)                 NOT NULL ENABLE,
  "FIRST_NAME"                    VARCHAR2(35 CHAR)                 NOT NULL ENABLE,
...
CREATE INDEX "PERSONS_NI2"
  ON "PERSONS" (UPPER("LAST_NAME"), UPPER("FIRST_NAME"));
