...
(
  ...
  "EMERGENCY_CONTACT_FLAG"        VARCHAR2(1 CHAR) DEFAULT 'N'      NOT NULL ENABLE,
  "NEXT_OF_KIN_FLAG"              VARCHAR2(1 CHAR) DEFAULT 'N'      NOT NULL ENABLE,
  "ACTIVE_FLAG"                   VARCHAR2(1 CHAR) DEFAULT 'N'      NOT NULL ENABLE,
  "EXPIRY_DATE"                   DATE,
  "OFFENDER_CONTACT_PERSON_ID"    NUMBER(10, 0)                     NOT NULL ENABLE,
  ...
  CONSTRAINT "OFF_CP_OFF_BKG_F1" FOREIGN KEY ("OFFENDER_BOOK_ID")
  REFERENCES "OFFENDER_BOOKINGS" ("OFFENDER_BOOK_ID") ENABLE,
  CONSTRAINT "OFF_CP_CONT_PT_F1" FOREIGN KEY ("CONTACT_TYPE", "RELATIONSHIP_TYPE")
  REFERENCES "CONTACT_PERSON_TYPES" ("CONTACT_TYPE", "RELATIONSHIP_TYPE") ENABLE,
  CONSTRAINT "OFF_CONTACT_PERSONS_PERSONS_FK" FOREIGN KEY ("PERSON_ID")
