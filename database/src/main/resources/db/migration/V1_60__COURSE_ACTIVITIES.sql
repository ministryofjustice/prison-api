...
(
  ...
  "COURSE_CLASS"                  VARCHAR2(12 CHAR) DEFAULT 'COURSE' NOT NULL ENABLE,
  ...
  CONSTRAINT "COURSE_ACTIVITIES_CHK1" CHECK (course_class IN ('COURSE', 'CRS_MOD', 'CRS_PH') ) ENABLE,
  ...
  REFERENCES "CORPORATES" ("CORPORATE_ID") ENABLE
);
