...
(
  ...
  "MOVEMENT_REASON_CODE"          VARCHAR2(12 CHAR)                 NOT NULL ENABLE,
  "DESCRIPTION"                   VARCHAR2(40 CHAR)                 NOT NULL ENABLE,
  "OPEN_CONTACT_FLAG"             VARCHAR2(1 CHAR) DEFAULT 'Y'      NOT NULL ENABLE,
  "CLOSE_CONTACT_FLAG"            VARCHAR2(1 CHAR) DEFAULT 'Y'      NOT NULL ENABLE,
  ...
  "UNEMPLOYMENT_PAY"              VARCHAR2(1 CHAR) DEFAULT 'N'      NOT NULL ENABLE,
