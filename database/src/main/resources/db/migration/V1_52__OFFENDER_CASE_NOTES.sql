...
(
  ...
  "CONTACT_DATE"                  DATE                              NOT NULL ENABLE,
  "CONTACT_TIME"                  DATE                              NOT NULL ENABLE,
  "CASE_NOTE_TYPE"                VARCHAR2(12 CHAR)                 NOT NULL ENABLE,
  "CASE_NOTE_SUB_TYPE"            VARCHAR2(12 CHAR)                 NOT NULL ENABLE,
  "STAFF_ID"                      NUMBER(10, 0)                     NOT NULL ENABLE,
  "CASE_NOTE_TEXT"                VARCHAR2(4000 CHAR),
  "AMENDMENT_FLAG"                VARCHAR2(1 CHAR) DEFAULT 'N'      NOT NULL ENABLE,
  "IWP_FLAG"                      VARCHAR2(1 CHAR) DEFAULT 'N'      NOT NULL ENABLE,
  "CHECK_BOX1"                    VARCHAR2(1 CHAR) DEFAULT 'N'      NOT NULL ENABLE,
  "CHECK_BOX2"                    VARCHAR2(1 CHAR) DEFAULT 'N'      NOT NULL ENABLE,
  "CHECK_BOX3"                    VARCHAR2(1 CHAR) DEFAULT 'N'      NOT NULL ENABLE,
  "CHECK_BOX4"                    VARCHAR2(1 CHAR) DEFAULT 'N'      NOT NULL ENABLE,
  "CHECK_BOX5"                    VARCHAR2(1 CHAR) DEFAULT 'N'      NOT NULL ENABLE,
  "EVENT_ID"                      NUMBER(10, 0),
  "CREATE_USER_ID"                VARCHAR2(32 CHAR) DEFAULT USER    NOT NULL ENABLE,
  "MODIFY_DATETIME"               TIMESTAMP(9),
  "MODIFY_USER_ID"                VARCHAR2(32 CHAR),
  "CASE_NOTE_ID"                  NUMBER(10, 0)                     NOT NULL ENABLE,
