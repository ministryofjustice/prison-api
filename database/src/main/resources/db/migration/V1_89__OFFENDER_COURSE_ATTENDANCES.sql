...
(
  ...
  "EVENT_STATUS"                  VARCHAR2(12 CHAR) DEFAULT 'SCH'   NOT NULL ENABLE,
  ...
  CONSTRAINT "OFFENDER_COURSE_ATTENDANCES_C1" CHECK (EVENT_CLASS IN ('INT_MOV', 'COMM', 'EXT_MOV')) ENABLE,
  ...
  REFERENCES "OFFENDER_TRANSACTIONS" ("TXN_ID", "TXN_ENTRY_SEQ") ENABLE
);
