...
(
  ...
  "IDENTIFIER_TYPE"               VARCHAR2(12 CHAR)                 NOT NULL ENABLE,
  "IDENTIFIER"                    VARCHAR2(20 CHAR)                 NOT NULL ENABLE,
  ...
  CONSTRAINT "OFFENDER_IDENTIFIERS_C1" CHECK ( verified_flag IN ('Y', 'N') ) ENABLE,
  CONSTRAINT "OFFENDER_IDENTIFIERS_UK1" UNIQUE ("ROOT_OFFENDER_ID", "IDENTIFIER_TYPE", "IDENTIFIER"),
  CONSTRAINT "OFF_ID_OFF_F1" FOREIGN KEY ("OFFENDER_ID")
