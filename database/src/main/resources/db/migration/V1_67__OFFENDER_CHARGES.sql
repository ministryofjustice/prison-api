...
(
  ...
  "OFFENDER_CHARGE_ID"            NUMBER(10, 0)                     NOT NULL ENABLE,
  "STATUTE_CODE"                  VARCHAR2(12 CHAR)                 NOT NULL ENABLE,
  "OFFENCE_CODE"                  VARCHAR2(25 CHAR)                 NOT NULL ENABLE,
  ...
  "MOST_SERIOUS_FLAG"             VARCHAR2(1 CHAR) DEFAULT 'N'      NOT NULL ENABLE,
  ...
  REFERENCES "OFFENCE_RESULT_CODES" ("RESULT_CODE") ENABLE,
  ...
  REFERENCES "OFFENCES" ("OFFENCE_CODE", "STATUTE_CODE") ENABLE NOVALIDATE
);
