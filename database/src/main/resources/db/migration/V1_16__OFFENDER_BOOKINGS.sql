...
(
  ...
  "BOOKING_BEGIN_DATE"            DATE                              NOT NULL ENABLE,
  ...
  "DISCLOSURE_FLAG"               VARCHAR2(1 CHAR) DEFAULT 'Y'      NOT NULL ENABLE,
  "IN_OUT_STATUS"                 VARCHAR2(12 CHAR)                 NOT NULL ENABLE,
  "ACTIVE_FLAG"                   VARCHAR2(1 CHAR) DEFAULT 'N',
  "BOOKING_STATUS"                VARCHAR2(12 CHAR),
  "YOUTH_ADULT_CODE"              VARCHAR2(12 CHAR)                 NOT NULL ENABLE,
  ...
  "BOOKING_SEQ"                   NUMBER(6, 0)                      NOT NULL ENABLE,
  CONSTRAINT "OFFENDER_BOOKINGS_PK" PRIMARY KEY ("OFFENDER_BOOK_ID"),
  CONSTRAINT "OFF_BKG_OFF_F1" FOREIGN KEY ("OFFENDER_ID")
  REFERENCES "OFFENDERS" ("OFFENDER_ID") ENABLE,
  CONSTRAINT "OFF_BKG_AGY_LOC_F1" FOREIGN KEY ("AGY_LOC_ID")
