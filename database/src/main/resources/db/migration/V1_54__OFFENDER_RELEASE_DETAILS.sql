...
(
  ...
  "MOVEMENT_TYPE"                 VARCHAR2(12 CHAR)                 NOT NULL ENABLE,
  ...
  "EVENT_ID"                      NUMBER(10, 0) DEFAULT NULL        NOT NULL ENABLE,
  ...
  CONSTRAINT "OFF_RELDE_OFF_BK_FK1" FOREIGN KEY ("OFFENDER_BOOK_ID")
  REFERENCES "OFFENDER_BOOKINGS" ("OFFENDER_BOOK_ID") ENABLE,
  CONSTRAINT "OFF_RELDE_MOV_RSN_FK1" FOREIGN KEY ("MOVEMENT_TYPE", "MOVEMENT_REASON_CODE")
