...
(
  "CONTACT_TYPE"                  VARCHAR2(12 CHAR)                 NOT NULL ENABLE,
  "RELATIONSHIP_TYPE"             VARCHAR2(12 CHAR)                 NOT NULL ENABLE,
  "LIST_SEQ"                      NUMBER(6, 0),
  ...
  CONSTRAINT "CONTACT_PERSON_TYPES_PK" PRIMARY KEY ("CONTACT_TYPE", "RELATIONSHIP_TYPE") ENABLE
) ;
