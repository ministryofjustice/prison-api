...
(
  "ALERT_DATE"                    DATE DEFAULT SYSDATE              NOT NULL ENABLE,
  "OFFENDER_BOOK_ID"              NUMBER(10, 0)                     NOT NULL ENABLE,
  "ROOT_OFFENDER_ID"              NUMBER(10, 0),
  "ALERT_SEQ"                     NUMBER(6, 0)                      NOT NULL ENABLE,
  "ALERT_TYPE"                    VARCHAR2(12 CHAR)                 NOT NULL ENABLE,
  "ALERT_CODE"                    VARCHAR2(12 CHAR)                 NOT NULL ENABLE,
  "AUTHORIZE_PERSON_TEXT"         VARCHAR2(40 CHAR),
  "CREATE_DATE"                   DATE,
  "ALERT_STATUS"                  VARCHAR2(12 CHAR)                 NOT NULL ENABLE,
  "VERIFIED_FLAG"                 VARCHAR2(1 CHAR) DEFAULT 'N'      NOT NULL ENABLE,
  "EXPIRY_DATE"                   DATE,
