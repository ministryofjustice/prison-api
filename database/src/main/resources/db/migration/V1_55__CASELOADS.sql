...
(
  ...
  "CASELOAD_TYPE"                 VARCHAR2(12 CHAR)                 NOT NULL ENABLE,
  "LIST_SEQ"                      NUMBER(6, 0),
  "TRUST_ACCOUNTS_FLAG"           VARCHAR2(1 CHAR) DEFAULT 'Y'      NOT NULL ENABLE,
  "ACCESS_PROPERTY_FLAG"          VARCHAR2(1 CHAR) DEFAULT 'N',
  "TRUST_CASELOAD_ID"             VARCHAR2(6 CHAR),
  "PAYROLL_FLAG"                  VARCHAR2(1 CHAR) DEFAULT 'N'      NOT NULL ENABLE,
  "ACTIVE_FLAG"                   VARCHAR2(1 CHAR) DEFAULT 'Y'      NOT NULL ENABLE,
  "DEACTIVATION_DATE"             DATE,
  "COMMISSARY_FLAG"               VARCHAR2(1 CHAR) DEFAULT 'N'      NOT NULL ENABLE,
  ...
  "MDT_FLAG"                      VARCHAR2(1 CHAR) DEFAULT 'N'      NOT NULL ENABLE,
  ...
  "CASELOAD_FUNCTION"             VARCHAR2(12 CHAR)                 NOT NULL ENABLE,
  CONSTRAINT "CASELOAD_PK" PRIMARY KEY ("CASELOAD_ID") ENABLE,
