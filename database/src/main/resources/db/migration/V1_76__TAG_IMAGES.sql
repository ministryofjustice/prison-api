...
(
  ...
  "IMAGE_OBJECT_TYPE"             VARCHAR2(12 CHAR)                 NOT NULL ENABLE,
  ...
  "ORIENTATION_TYPE"              VARCHAR2(12 CHAR)                 NOT NULL ENABLE,
  "FULL_SIZE_IMAGE"               BLOB,
  "THUMBNAIL_IMAGE"               BLOB,
  "ACTIVE_FLAG"                   VARCHAR2(1 CHAR) DEFAULT 'N'      NOT NULL ENABLE,
  ...
  "IMAGE_SOURCE_CODE"             VARCHAR2(12 CHAR)                 NOT NULL ENABLE,
