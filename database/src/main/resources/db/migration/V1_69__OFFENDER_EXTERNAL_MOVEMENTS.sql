...
(
  ...
  "MOVEMENT_SEQ"                  NUMBER(6, 0) DEFAULT 99           NOT NULL ENABLE,
  "MOVEMENT_DATE"                 DATE                              NOT NULL ENABLE,
  "MOVEMENT_TIME"                 DATE                              NOT NULL ENABLE,
  ...
  CONSTRAINT "OFF_EXT_MOV_ADDR_FK" FOREIGN KEY ("TO_ADDRESS_ID")
  REFERENCES "ADDRESSES" ("ADDRESS_ID") ENABLE,
  CONSTRAINT "OFF_EM_OFF_BKG_F1" FOREIGN KEY ("OFFENDER_BOOK_ID")
  REFERENCES "OFFENDER_BOOKINGS" ("OFFENDER_BOOK_ID") ENABLE,
  CONSTRAINT "OFF_EM_MOVE_RSN_F1" FOREIGN KEY ("MOVEMENT_TYPE", "MOVEMENT_REASON_CODE")
  REFERENCES "MOVEMENT_REASONS" ("MOVEMENT_TYPE", "MOVEMENT_REASON_CODE") ENABLE,
  CONSTRAINT "OFF_EM_INT_SR_F1" FOREIGN KEY ("INTERNAL_SCHEDULE_TYPE", "INTERNAL_SCHEDULE_REASON_CODE")
  REFERENCES "INTERNAL_SCHEDULE_REASONS" ("INTERNAL_SCHEDULE_TYPE", "INTERNAL_SCHEDULE_RSN_CODE") ENABLE,
  CONSTRAINT "OFF_EM_AGY_LOC_F3" FOREIGN KEY ("TO_AGY_LOC_ID")
  REFERENCES "AGENCY_LOCATIONS" ("AGY_LOC_ID") ENABLE,
  CONSTRAINT "OFF_EM_AGY_LOC_F2" FOREIGN KEY ("FROM_AGY_LOC_ID")
  REFERENCES "AGENCY_LOCATIONS" ("AGY_LOC_ID") ENABLE,
  CONSTRAINT "OFF_EXT_MOV_FROM_ADDR_FK" FOREIGN KEY ("FROM_ADDRESS_ID")
  REFERENCES "ADDRESSES" ("ADDRESS_ID") ENABLE
);
