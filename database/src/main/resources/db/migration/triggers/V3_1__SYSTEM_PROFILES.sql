CREATE OR REPLACE TRIGGER "SYSTEM_PROFILES_T1"
AFTER
UPDATE
  ON system_profiles
...
FOR EACH ROW
  BEGIN
    ...
    */
    IF :New.Profile_type = 'DB'
    THEN
      INSERT INTO DB_PATCHES (PROFILE_CODE, PROFILE_VALUE)
      VALUES (:new.Profile_code, :new.Profile_value);
    END IF;
...
CREATE OR REPLACE TRIGGER "SYSTEM_PROFILES_TA"
BEFORE INSERT OR UPDATE OR DELETE ON SYSTEM_PROFILES
