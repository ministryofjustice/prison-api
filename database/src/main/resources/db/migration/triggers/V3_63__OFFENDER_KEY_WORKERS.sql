...
CREATE OR REPLACE TRIGGER "OFFENDER_KEY_WORKERS_TA"
BEFORE INSERT OR UPDATE OR DELETE ON OFFENDER_KEY_WORKERS
REFERENCING NEW AS NEW OLD AS OLD FOR EACH ROW
  ...
  BEGIN
    /*
    ============================================================
       Generated by 2.3  Date Generation 12-JUN-2017
    ============================================================
