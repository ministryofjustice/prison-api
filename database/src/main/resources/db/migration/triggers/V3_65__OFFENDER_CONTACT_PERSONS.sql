...
CREATE OR REPLACE TRIGGER "OFFENDER_CONTACT_PERSONS_T1"
BEFORE
INSERT OR UPDATE
  ON offender_contact_personS
REFERENCING NEW AS NEW OLD AS OLD
FOR EACH ROW
  DECLARE
    lv_offender_contact_person_ID NUMBER(10);
  BEGIN
    ...
    */
    IF :NEW.Offender_Contact_person_ID IS NULL
    THEN
      SELECT offender_contact_person_ID.NEXTVAL
      INTO lv_offender_contact_person_ID
      FROM DUAL;
      :NEW.offender_contact_person_ID := lv_offender_contact_person_ID;
    END IF;
  END;
...
CREATE OR REPLACE TRIGGER "OFFENDER_CONTACT_PERSONS_TA"
BEFORE INSERT OR UPDATE OR DELETE ON OFFENDER_CONTACT_PERSONS
