...
There is an alert in Application Insights called `Elite2-api - Inactivity alert`. It fires if prison-api hasn't received and real requests in the last 10 minutes.
